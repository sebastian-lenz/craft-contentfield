...
var y=l&&p.length>1,g=r&&v&&!u.__visible
return t.createElement(ot,null,t.createElement(Ye,null,y||g?t.createElement("div",{className:"tcfInstance--controls"},y?t.createElement(st,{disabled:s,dispatch:h,model:v?u:null,path:f,schemas:p}):null,g?t.createElement(ct,{disabled:s,dispatch:h,model:u}):null):null,v?t.createElement(Kn,{disabled:s,model:u,isBorderless:c,path:f}):null))}),or=function(e){function t(e){var n
