...
void 0===s&&(s=-1===t.indexOf(e)),s?a.push(e):a=a.filter((t=>t!==e)),n(a)}}},e)}function xe({children:e,disabled:t,onClick:n,primary:a,secondary:r}){return s.createElement("div",{className:Ce()("tcfButton btn",{disabled:t,submit:a,secondary:r}),onClick:e=>{e.preventDefault(),t||n(e)}},e)}function Ne({className:e,params:t,value:n}){return s.createElement("span",{className:e},g(n,t))}function ke({children:e,className:t}){return s.createElement("div",{className:Ce()("tcfWindow--content",t)},e)}function je({children:e,className:t,flex:n=!0}){return s.createElement("div",{className:Ce()("tcfWindow--footer flex-nowrap",t,{flex:n})},e)}function Me({children:e,className:t,width:n}){return s.createElement("div",{className:Ce()("tcfWindow",t),style:{width:n}},e)}!function(e){e.Content=ke,e.Footer=je}(Me||(Me={}))
const Ie=Me
function Le({onClose:e}){return s.createElement(Ie,{width:600},s.createElement(Ie.Content,null,s.createElement(Ne,{value:"Cannot create an element at the given location."})),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:e,secondary:!0},s.createElement(Ne,{value:"Cancel"}))))}const $e="toolbar"
...
if(null===r)return s.createElement(Le,{onClose:function(){n(k(null))}})
...
c(s)&&("expand"===e?a.toggleExpanded(s.__uuid,!0):i={type:"edit",uuid:s.__uuid}),n(function(e,t,n){return{position:n,type:"uuidInsert",uuid:e,value:t}}(t,s,r)),n(k(i))},scope:o.__type})}function De(e){const{field:t}=e,{widget:n}=v.getDefinition(t)
...
return s.createElement(Oe,null,s.createElement(Ie,null,s.createElement(Ie.Content,null,s.createElement(qe,{model:e,path:t})),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:this.handleApply},s.createElement(Ne,{value:"Apply"})))))}}const Xe=(0,l.$j)(((e,t)=>d(e,t.uuid)),(e=>({setOverlay:t=>e(k(t))})))(Ge),Ke="craft:",Je="material:"
function Ye({className:e,name:t,size:n}){let a="craft"
return t.startsWith(Je)?(a="material",t=t.substr(Je.length)):t.startsWith(Ke)&&(t=t.substr(Ke.length)),s.createElement("div",{className:Ce()("tcfIcon",e,a,n)},t)}function Qe({message:e,onClose:t}){return s.createElement(s.Fragment,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfSynchronize--message"},s.createElement(Ye,{className:"tcfSynchronize--messageIcon error",name:"material:error",size:"huge"}),s.createElement("div",{className:"tcfSynchronize--title"},"An error has occured"),e?s.createElement("div",{className:"tcfSynchronize--message"},e):null)),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:t},"Close")))}function Ze({onClose:e}){return s.createElement(s.Fragment,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfSynchronize--message"},s.createElement(Ye,{className:"tcfSynchronize--messageIcon finished",name:"material:check_circle",size:"huge"}),s.createElement("div",{className:"tcfSynchronize--title"},s.createElement(Ne,{value:"Sites have been synchronized"})),s.createElement("div",{className:"tcfSynchronize--message"},s.createElement(Ne,{value:"If you are not happy with the results, do not save the entry. Reload this page to revert all changes."})))),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:e},s.createElement(Ne,{value:"Close"}))))}class et extends s.Component{constructor(){super(...arguments),this.element=null,this.lightswitch=null,this.handleChange=()=>{const{disabled:e,onChange:t}=this.props,{lightswitch:n}=this
...
return s.createElement(s.Fragment,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfSynchronize--title"},s.createElement(Ne,{value:"Synchronize translations"})),s.createElement(Te,null,s.createElement(Ae,{instructions:g("Select the site the content should be copied from."),label:g("Site")},s.createElement(Re,{onChange:this.handleSiteChange,options:o,value:i})),s.createElement(Ae,{instructions:g("Defines what happens to elements that do not exist in the selected language."),label:g("Orphaned elements")},s.createElement(Re,{onChange:this.handleArrayOrphanModeChange,options:[{key:"hide",label:g("Hide orphaned elements")},{key:"none",label:g("Do nothing")},{key:"remove",label:g("Remove orphaned elements")}],value:r})),i&&t&&i.language!==t.language?s.createElement(Ae,{instructions:g(n?"Uses a webservice to automatically translate texts.":"A matching webservice must be configured in the options of this field in order to use this feature."),label:g("Translate texts automatically")},s.createElement(et,{disabled:!n,onChange:this.handleToggleTranslator,value:l})):null)),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:a,secondary:!0},s.createElement(Ne,{value:"Cancel"})),s.createElement(xe,{onClick:this.handleApply,primary:!0},s.createElement(Ne,{value:"Apply"}))))}}const nt=(0,l.$j)((e=>{const{apiEndpoints:t,elementSiteId:n,hasTranslator:s,supportedSites:a}=e.config
...
return l.sort(Pe),s.createElement(Ae,{className:"tcfInstance--controlsSchema",label:"Type"},s.createElement(Re,{disabled:e,onChange:e=>t(function(e,t,n){return{expandedState:n,newType:t,path:e,type:"changeType"}}(a,e,i)),options:l,value:n?n.__type:null}))}function ct({disabled:e,dispatch:t,model:n}){const a=n.__visible?"material:visibility":"material:visibility_off",r=s.createElement(s.Fragment,null,s.createElement(Ne,{value:"Visibility"}),s.createElement(Ye,{className:Ce()("tcfInstance--controlsVisibilityIcon",{off:!n.__visible}),name:a}))
return s.createElement(Ae,{label:r,className:"tcfInstance--controlsVisibility"},s.createElement(xe,{disabled:e,onClick:()=>t(L(n.__uuid))},s.createElement(Ne,{value:n.__visible?"Hide":"Show"})))}const ut=s.memo((function({canChangeVisibility:e=!1,canChangeType:t=!0,disabled:n=!1,isBorderless:a,model:r,path:i,schemaNames:o}){const u=(0,l.I0)(),d=(0,l.v9)((e=>o.map((t=>e.schemas[t]))))
let m=!1
...
return s.createElement(be.W,{backend:Ee.PD},s.createElement(Oe,null,o&&!a?s.createElement("div",{className:"tcfRoot--options"},s.createElement(Se,{onClick:()=>{e(A({status:"idle"})),e(k({type:"synchronize"}))},outline:!0},s.createElement(Ye,{name:"material:sync"}),s.createElement(Ne,{value:"Synchronize translations"}))):null,s.createElement(ut,{disabled:a,model:t,path:[],schemaNames:r}),n?s.createElement(dt,{onClick:()=>{n&&!n.preventClose&&e(k(null))}},function(e){if(!e)return null
...
const i=N(r),{targetPath:l,targetSegment:o}=_(i)
...
const r=N(a),{targetPath:i,targetSegment:l}=_(r)
...
let C
return w?C=s.createElement("div",{className:"tcfArrayWidgetMember--body"},s.createElement(ut,{canChangeType:!1,disabled:d,isBorderless:b,key:"details",model:c,path:p,schemaNames:m.schemas})):E&&(C=s.createElement(Ht,{className:"tcfArrayWidgetMember--preview",field:m,key:"summary",model:c,onClick:v?y:void 0})),s.createElement("div",{className:Ce()(`tcfArrayWidgetMember depth-${u}`,w?"isExpanded":"isCollapsed",{isDragging:r}),ref:a},l(s.createElement("div",{className:"tcfArrayWidgetMember--panel"},s.createElement(Dt,{disabled:d,dragSource:i,field:m,hasPreview:!w&&!E,isCollapsible:v&&h,isExpanded:w,model:c,onToggleExpanded:y,schema:g}),s.createElement(kt,{uri:w?"details":"summary"},C))))}function zt({children:e,data:t,disabled:n,field:a,model:r,onDelete:i,onUpdate:o,path:c}){const{member:u,collapsible:d,previewMode:m}=a,h=s.useRef(null),p=(0,l.v9)((e=>e.schemas)),f=s.useContext(it),g=t.map(((e,t)=>{const a=[...c,{index:t,name:u.name,type:"index"}],l={child:e,depth:f,disabled:n,path:a}
...
t(s)},secondary:!0},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"})))}qt.contextType=_e
...
let r=e in a?a[e]:[]
r=-1===r.indexOf(t)?[...r,t]:r.filter((e=>e!==t)),n({type:"setUser",user:{favoriteSchemas:Object.assign(Object.assign({},a),{[e]:r})}})}}(n,e.qualifier))}}return s.createElement("div",{className:"tcfFactory multiple"},s.createElement(Se,{className:"tcfFactory--primaryButton",onMouseDown:()=>r(!0)},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"}),a?s.createElement(Rt,{onClick:()=>r(!1)},s.createElement(On,{favorites:c,onSchema:t=>{r(!1),e(t)},onToggleFavorite:o,schemas:t})):null),u)}function Nn({onCreate:e,schema:t}){return s.createElement("div",{className:"tcfFactory"},s.createElement(Se,{className:"tcfFactory--primaryButton",onClick:()=>e(t)},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{params:{schema:t.label},value:"Create {schema}"})))}function kn({field:e,onCreate:t,scope:n}){const a=(0,l.v9)((e=>e.schemas)),r=e.schemas.map((e=>a[e])).sort(((e,t)=>e.label.localeCompare(t.label)))
if(!r.length)return null
const i=e=>{if(-1!==r.indexOf(e))return t(E({schemas:a,schema:e}))}
return r.length>1?s.createElement(xn,{onCreate:i,schemas:r,scope:n}):s.createElement(Nn,{onCreate:i,schema:r[0]})}function jn({children:e,disabled:t,field:n,model:a}){const r=s.useContext(it),i=(0,l.v9)((e=>e.schemas)),{isExpanded:o,toggleExpanded:c}=s.useContext(_e),u=i[a.__type],d=o(a.__uuid),m=u&&u.preview,h=()=>c(a.__uuid)
let p=null
return d?p=s.createElement("div",{className:"tcfArrayWidgetMember--body"},e):m&&(p=s.createElement(Ht,{field:n,model:a,onClick:h})),s.createElement("div",{className:`tcfInstanceWidget--collapsiblePanel depth-${r}`},s.createElement(Dt,{disabled:t,field:n,hasPreview:!d&&!m,isCollapsible:!0,isExpanded:d,model:a,onToggleExpanded:h,schema:u}),s.createElement(kt,{uri:d?"details":"summary"},p))}function Mn({className:e,data:t,disabled:n,field:a,path:r}){const i=s.createElement(ut,{canChangeVisibility:!0,disabled:n,model:t,path:[...r,{type:"property",name:a.name}],schemaNames:a.schemas})
...
function h(e){d(e===u?null:e)}return s.createElement(Ie,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfLayoutEditor--title"},s.createElement(Ne,{value:"Edit columns"})),i.map((e=>s.createElement(Fn,Object.assign({},r,{current:e,key:e.key,selected:m,onSelect:h}))))),s.createElement(Ie.Footer,null,s.createElement("div",{className:"btngroup"},l.length<o?s.createElement(xe,{onClick:()=>d(n())},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"})):null,m&&l.length>c?s.createElement(xe,{onClick:()=>a(m.__uuid)},s.createElement(Ye,{name:"minus"}),s.createElement(Ne,{value:"Delete"})):null),s.createElement(xe,{onClick:t,primary:!0},s.createElement(Ne,{value:"Close"}))))}function Dn(e){var{onClose:t,onPreset:n,preset:a,presets:r}=e,i=(0,P._T)(e,["onClose","onPreset","preset","presets"])
...
let n
t&&0===t.length?n=s.createElement(bn,{icon:"material:error"},"No locations found"):t&&(n=s.createElement(rs,{onSelect:this.handleResultsSelect,results:t})),e=s.createElement("div",{className:"tcfLocationFieldSearch--resolve"},n?s.createElement(Rt,{onClick:this.handleResultsCancel},n):null,s.createElement(xe,{onClick:this.handleResolve},s.createElement(Ne,{value:"Resolve address"})))}return s.createElement("div",{className:"tcfLocationFieldSearch"},e,s.createElement("input",{className:"tcfLocationFieldSearch--input tcfInput",ref:this.setInput,type:"search"}))}}function os(e){return"object"==typeof e&&"number"==typeof e.latitude&&"number"==typeof e.longitude}var cs
...
return a}return this.createValue(e)}))}createValue(e){return[]}isValue(e,t){return Array.isArray(t)}preview(e){return new Et(e)}},checkbox:new class extends Jt{constructor(){super({widget:Qt}),this.isAlwaysPlainField=!0}},color:new class extends Kt{constructor(){super({widget:vn})}createValue(e){return{alpha:1,blue:255,green:255,red:255}}isValue(e,t){return en(t)}preview({context:e,value:t}){return""}},instance:new class extends Kt{constructor(){super({factory:kn,widget:Mn})}cloneValue(e){return(0,P.mG)(this,void 0,void 0,(function*(){const{field:t,value:n}=e,s=(0,P._T)(e,["field","value"])
...
i.className="tcfDetailsToggle",i.append(r),a.insertBefore(i,a.querySelector("#save-btn-container")||a.firstElementChild),t(n,s,r)}()}},n={}
