...
return s.createElement(Me,{width:600},s.createElement(Me.Content,null,s.createElement(Ne,{value:"Cannot create an element at the given location."})),s.createElement(Me.Footer,null,s.createElement(xe,{onClick:t,secondary:!0},s.createElement(Ne,{value:"Cancel"}))))}const Te="toolbar"
...
return s.createElement(Oe,null,s.createElement(Me,null,s.createElement(Me.Content,null,s.createElement(qe,{model:e,path:t})),s.createElement(Me.Footer,null,s.createElement(xe,{onClick:this.handleApply},s.createElement(Ne,{value:"Apply"})))))}}var Xe=(0,i.$j)(((e,t)=>d(e,t.uuid)),(e=>({setOverlay:t=>e(k(t))})))(Ge)
...
return s.createElement(s.Fragment,null,s.createElement(Me.Content,null,s.createElement("div",{className:"tcfSynchronize--message"},s.createElement(Ye,{className:"tcfSynchronize--messageIcon finished",name:"material:check_circle",size:"huge"}),s.createElement("div",{className:"tcfSynchronize--title"},s.createElement(Ne,{value:"Sites have been synchronized"})),s.createElement("div",{className:"tcfSynchronize--message"},s.createElement(Ne,{value:"If you are not happy with the results, do not save the entry. Reload this page to revert all changes."})))),s.createElement(Me.Footer,null,s.createElement(xe,{onClick:t},s.createElement(Ne,{value:"Close"}))))}class et extends s.Component{constructor(){super(...arguments),this.element=null,this.lightswitch=null,this.handleChange=()=>{const{disabled:e,onChange:t}=this.props,{lightswitch:n}=this
...
return"instance"===d.type?s.createElement(Jt,Object.assign({},r,{isCollapsible:m,field:d,key:e.__uuid,previewMode:h,schema:f[e.__type]})):s.createElement(xt,Object.assign({},r,{field:d,index:t,key:pe(e)?e.__uuid:t,model:l,onDelete:o,onUpdate:c}))}))
...
n(e)},secondary:!0},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"})))}Qt.contextType=_e
...
return s.createElement("div",{className:Ce()("tcfTextAndIcon",n)},s.createElement(Ye,{className:"tcfTextAndIcon--icon",name:a}),s.createElement(Ne,{className:"tcfTextAndIcon--text",value:t}))}function xn(e){let{children:t,title:n}=e
return s.createElement("div",{className:"tcfErrorMessage"},s.createElement(On,{icon:"material:error"},n),t)}class Nn extends s.Component{constructor(){super(...arguments),this.request=null,this.state={mode:"idle"},this.handleChange=e=>{this.updateOEmbed(),this.setState({mode:"typing"}),this.props.onUpdate(Object.assign(Object.assign({},this.getOEmbed()),{url:e.target.value}))},this.updateOEmbed=function(e,t,n){let s,a,r=null,l=null,i=null
...
let r=e in a?a[e]:[]
r=-1===r.indexOf(t)?[...r,t]:r.filter((e=>e!==t)),n({type:"setUser",user:{favoriteSchemas:Object.assign(Object.assign({},a),{[e]:r})}})}}(a,e.qualifier))}}return s.createElement("div",{className:"tcfFactory multiple"},s.createElement(Se,{className:"tcfFactory--primaryButton",onMouseDown:()=>l(!0)},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"}),r?s.createElement(Ht,{onClick:()=>l(!1)},s.createElement(In,{favorites:u,onSchema:e=>{l(!1),t(e)},onToggleFavorite:c,schemas:n})):null),d)}function Ln(e){let{onCreate:t,schema:n}=e
return s.createElement("div",{className:"tcfFactory"},s.createElement(Se,{className:"tcfFactory--primaryButton",onClick:()=>t(n)},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{params:{schema:n.label},value:"Create {schema}"})))}function Tn(e){let{field:t,onCreate:n,scope:a}=e
...
function h(e){d(e===u?null:e)}return s.createElement(Me,null,s.createElement(Me.Content,null,s.createElement("div",{className:"tcfLayoutEditor--title"},s.createElement(Ne,{value:"Edit columns"})),l.map((e=>s.createElement(Bn,Object.assign({},r,{current:e,key:e.key,selected:m,onSelect:h}))))),s.createElement(Me.Footer,null,s.createElement("div",{className:"btngroup"},i.length<o?s.createElement(xe,{onClick:()=>d(n())},s.createElement(Ye,{name:"plus"}),s.createElement(Ne,{value:"Create"})):null,m&&i.length>c?s.createElement(xe,{onClick:()=>a(m.__uuid)},s.createElement(Ye,{name:"minus"}),s.createElement(Ne,{value:"Delete"})):null),s.createElement(xe,{onClick:t,primary:!0},s.createElement(Ne,{value:"Close"}))))}function qn(e){var{onClose:t,onPreset:n,preset:a,presets:r}=e,l=(0,A._T)(e,["onClose","onPreset","preset","presets"])
...
let n
t&&0===t.length?n=s.createElement(On,{icon:"material:error"},"No locations found"):t&&(n=s.createElement(us,{onSelect:this.handleResultsSelect,results:t})),e=s.createElement("div",{className:"tcfLocationFieldSearch--resolve"},n?s.createElement(Ht,{onClick:this.handleResultsCancel},n):null,s.createElement(xe,{onClick:this.handleResolve},s.createElement(Ne,{value:"Resolve address"})))}return s.createElement("div",{className:"tcfLocationFieldSearch"},e,s.createElement("input",{className:"tcfLocationFieldSearch--input tcfInput",ref:this.setInput,type:"search"}))}}function hs(e){return"object"==typeof e&&"number"==typeof e.latitude&&"number"==typeof e.longitude}var ps
...
return t}}function Ns(e){let{data:t,disabled:n,field:a,model:r,onUpdate:l}=e
return s.createElement(Zn,{allowSelfReference:a.allowSelfReference,condition:a.condition,criteria:a.criteria,disabled:n,data:t,elementType:a.elementType,limit:a.limit||null,modalStorageKey:a.modalStorageKey||`tcf_${r.__type}_${a.name}`,onUpdate:l,referenceElementId:a.referenceElementId,referenceElementSiteId:a.referenceElementSiteId,showSiteMenu:a.showSiteMenu,sources:a.sources||null,viewMode:a.viewMode})}(0,A.gn)([vt],xs.prototype,"asBackground",null),(0,A.gn)([vt],xs.prototype,"asLargeElement",null),(0,A.gn)([vt],xs.prototype,"asLargeImage",null),(0,A.gn)([vt],xs.prototype,"asSmallElement",null),(0,A.gn)([vt],xs.prototype,"asSmallImage",null),(0,A.gn)([vt],xs.prototype,"firstLabel",null),(0,A.gn)([vt],xs.prototype,"label",null),(0,A.gn)([yt],xs.prototype,"toHTML",null),(0,A.gn)([yt],xs.prototype,"toString",null)
...
return new vs(t)}},reference:new class extends tn{constructor(){super({widget:Ns})}createValue(e){return[]}isValue(e,t){return Array.isArray(t)&&t.every(Tt)}preview(e){return new xs(e)}},select:new class extends ks{constructor(){super({widget:js})}},swatchcolor:new class extends ks{constructor(){super({widget:Ms})}},text:new class extends _s{constructor(){super({widget:Ls})}},textarea:new class extends _s{constructor(){super({widget:Ts})}}})
n(524)
