...
return e.id===n&&e.type===r})||(e.$element=$(e.element),e.hasThumb=e.$element.hasClass("hasthumb"),n.push(e))}()}catch(e){a=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(a)throw i}}return Object.assign({},e,{config:Object.assign({},e.config,{references:n})})}function C(e){return{references:e,type:"addReferences"}}function _(){return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,function(e){return(e^crypto.getRandomValues(new Uint8Array(1))[0]&15>>e/4).toString(16)})}function w(e){for(var t=e.schemas,n=e.schema,r=e.oldModel,a={__errors:{},__type:n.qualifier,__uuid:_(),__visible:!0},i=0,l=Object.keys(n.fields);i<l.length;i++){var o=l[i],s=n.fields[o],c=jn.getDefinition(s),u=r&&o in r?r[o]:void 0
...
var f=c.member,m=jn.getDefinition(f.type),h=v(e.model,l)
...
try{window.localStorage.setItem(Tn,JSON.stringify(r))}catch(e){console.error(e)}return Object.assign({},e,{user:r})}function U(e){return{type:"setUser",user:e}}function F(e,t,n){var r=e.fields[n].validatorId
if(!r)return null
var a=ua.getValidator(r)
if(!a)return null
var i=[]
...
break}return o=l[i],s=r.fields[o],c=jn.getDefinition(s),e.next=11,c.cloneValue(Object.assign({},n,{field:s,value:t[o]}))
case 11:a[o]=e.sent
case 12:i++,e.next=5
break
...
return new Promise(function(e,n){fetch("".concat(t,"&").concat(r)).then(function(e){return e.json()}).then(function(t){ne(t)?e(t):n(t&&t.message?"".concat(t.message):"An unknown error has occured.")}).catch(function(e){n("".concat(e))})})}function ae(e){return d(e)?"[".concat(e.__type,", ").concat(e.__uuid,"]"):"[no model]"}function ie(e){return e&&e.verbose?Ln:Un}function le(e){if(!Array.isArray(e))return[]
...
return n&&"array"===n.field.type?{group:Pn.Manipulation,icon:"material:add",id:"create",invoke:function(e){e(T({afterCreate:arguments.length>1&&void 0!==arguments[1]&&arguments[1]?"layer":"expand",type:"create",uuid:t}))},label:g("Create")}:null}function he(e){e.owner
return null}function pe(e){var t=e.owner,n=e.location.uuid
return t&&"array"===t.field.type?{group:Pn.Manipulation,icon:"material:delete",id:"delete",invoke:function(e){e(q(n))},label:g("Delete")}:null}function ve(e){var t=e.location.uuid
return{group:Pn.Manipulation,icon:"material:edit",id:"edit",invoke:function(e){e(T({type:"edit",uuid:t}))},label:g("Edit")}}function ye(e){var t=e.location.uuid,n=e.owner
if(!n||"array"!==n.field.type)return null
var r=n.owner[n.field.name]
return!Array.isArray(r)||void 0===n.index||n.index>=r.length-1?null:{group:Pn.Movement,icon:"material:arrow_downward",id:"moveDown",invoke:function(e){return e(z(t,"down"))},label:g("Move down")}}function ge(e){var t=e.location.uuid,n=e.owner
if(!n||"array"!==n.field.type)return null
var r=n.owner[n.field.name]
return!Array.isArray(r)||void 0===n.index||n.index<=0?null:{group:Pn.Movement,icon:"material:arrow_upward",id:"moveUp",invoke:function(e){return e(z(t,"up"))},label:g("Move up")}}function be(e){e.owner
return null}function Ee(e){var t=e.location,n=t.uuid,r=t.model.__visible
return{group:Pn.Visibility,icon:r?"material:visibility_off":"material:visibility",id:"visibility",invoke:function(e){e(G(n))},label:g(r?"Hide":"Show")}}function Ce(e,t){var n=m(e,t),r=[]
if(!n)return r
var a={location:n,owner:y(e,n.path),state:e}
return Dn.map(function(e){return e(a)}).filter(function(e){return null!==e})}function _e(e,t){var n=t.uuid,r=null
return{getCommands:function(){return Ce(e.getState(),n).map(function(t){return Object.assign({},t,{invoke:function(){return t.invoke(e.dispatch,!0)}})})},subscribe:function(t){r&&r(),r=e.subscribe(t)},unsubscribe:function(){r&&r(),r=null}}}function we(e){Vn=e}function ke(){return Vn}function Se(){return Hn||(Hn=new Promise(function(e){window.onGoogleMapsReady=function(){zn=Wn.Loaded,e(google.maps)}
var t=document.createElement("script")
t.src="https://maps.googleapis.com/maps/api/js?key=".concat(Vn,"&libraries=places&callback=onGoogleMapsReady"),(document.head||document.body).appendChild(t),Hn=Hn,zn=Wn.Loading}))}function xe(e){return e&&"object"===_typeof(e)&&"__uuid"in e}function Oe(e){switch(_typeof(e)){case"boolean":return new Boolean(e)
...
return e}function Ae(e){return"string"==typeof e&&""!==e.trim()?Mn.compile(e):null}function Re(e){return Object.keys(e).reduce(function(t,n){return Array.isArray(e[n])?Object.assign({},t,_defineProperty({},n,e[n])):t},{})}function Me(){try{var e=window.localStorage.getItem(Tn)
...
return t.createElement("div",Object.assign({},l,{className:Bn("tcfButtonFlat",r,{outline:a,secondary:i})}),n)}function Te(e){var n=e.children,r=_slicedToArray(t.useState([]),2),a=r[0],i=r[1],l=function(e){return-1!==a.indexOf(e)},o=function(e,t){var n=_toConsumableArray(a)
void 0===t&&(t=-1===a.indexOf(e)),t?n.push(e):n=n.filter(function(t){return t!==e}),i(n)}
return t.createElement(qn.Provider,{value:{expanded:a,isExpanded:l,toggleExpanded:o}},n)}function Le(e){var n=e.children,r=e.disabled,a=e.onClick,i=e.primary,l=e.secondary
return t.createElement("div",{className:Bn("tcfButton btn",{disabled:r,submit:i,secondary:l}),onClick:function(e){e.preventDefault(),r||a(e)}},n)}function Ue(e){var n=e.className,r=e.params,a=e.value
return t.createElement("span",{className:n},g(a,r))}function Fe(e){var n=e.children,r=e.className
return t.createElement("div",{className:Bn("tcfWindow--content",r)},n)}function De(e){var n=e.children,r=e.className,a=e.flex,i=void 0===a||a
return t.createElement("div",{className:Bn("tcfWindow--footer",r,{flex:i})},n)}function We(e){var n=e.children,r=e.className,a=e.width
return t.createElement("div",{className:Bn("tcfWindow",r),style:{width:a}},n)}function Ve(e){var n=e.onClose
return t.createElement(Xn,{width:600},t.createElement(Xn.Content,null,t.createElement(Ue,{value:"Cannot create an element at the given location."})),t.createElement(Xn.Footer,null,t.createElement(Le,{onClick:n,secondary:!0},t.createElement(Ue,{value:"Cancel"}))))}function He(e){var n=e.children,r=e.isBorderless,a=e.label,i=e.style
return a&&""!==a&&a!==Gn?t.createElement("div",{className:"tcfFieldGroup",style:i},t.createElement("div",{className:"tcfFieldGroup--label"},a),t.createElement("div",{className:"tcfFieldGroup--content"},n)):t.createElement("div",{className:Bn("tcfFieldGroup--content",{isBorderless:r}),style:i},n)}function ze(e){var n=e.children,r=e.className,a=e.errors,i=e.instructions,l=e.isPlainField,o=e.isRequired,s=e.label,c=e.style
if(l)return t.createElement(t.Fragment,null,n)
var u=a&&a.length
return t.createElement("div",{className:Bn("tcfFieldPanel",r),style:c},t.createElement("div",{className:Bn("tcfFieldPanel--label",{hasErrors:u,isRequired:o})},s),i?t.createElement("div",{className:"tcfFieldPanel--instructions"},i):null,a&&a.length?t.createElement("ul",{className:"tcfFieldPanel--errors"},a.map(function(e,n){return t.createElement("li",{className:"tcfFieldPanel--error",key:n},e)})):null,n)}function Be(e,t){return e.label.localeCompare(t.label)}function qe(e){function n(e){var t=e.target.selectedIndex,n=null
...
return t.createElement(Xn,{width:600},t.createElement(Xn.Content,null,t.createElement(He,null,t.createElement(ze,{instructions:g("Select where the new element should be inserted."),label:g("Position")},t.createElement(qe,{onChange:s,options:Yn.map(function(e){return Object.assign({},e,{label:g(e.label)})}),value:o})))),t.createElement(Xn.Footer,{flex:!1},t.createElement(n,{field:r,onCreate:function(e){return a(e,o)},scope:i})))}function Xe(e){function n(){s(T(null))}function r(e,t){var n=null
d(e)&&("expand"===l?c.toggleExpanded(e.__uuid,!0):n={type:"edit",uuid:e.__uuid}),s(V(o,e,t)),s(T(n))}var a=e.afterCreate,l=void 0===a?"expand":a,o=e.uuid,s=i.useDispatch(),c=t.useContext(qn),u=i.useSelector(function(e){var t=m(e,o)
...
var f=u.field,h=u.model,p=jn.getDefinition(f.member.type).factory
return t.createElement($e,{Factory:p,field:f.member,onCreate:r,scope:h.__type})}function Ge(e){var n=e.field,r=jn.getDefinition(n).widget
return t.createElement(r,e)}function Ye(e){var n=e.children,r=Z(e,["children"]),a=_slicedToArray(t.useState($n.Large),2),i=a[0],l=a[1],o=t.useRef(null)
return t.useEffect(function(){var e=window.ResizeObserver,t=o.current,n=-1,r=0
if(t){var a=function(){var e=t.offsetWidth
e!==r&&l((r=e)>920?$n.Large:r>580?$n.Medium:$n.Small)}
if(e){var i=new e(a)
return i.observe(t),function(){return i.unobserve(t)}}return function e(){n=window.requestAnimationFrame(e),a()}(),function(){return window.cancelAnimationFrame(n)}}},[]),t.createElement("div",Object.assign({ref:o},r),t.createElement(Jn.Provider,{value:i},n))}function Je(e,t){if(t)switch(e){case $n.Small:return t.small
case $n.Large:return t.large
default:return t.medium}}function Ke(e,t){return e.index-t.index}function Qe(e){var n=e.disabled,r=void 0!==n&&n,a=e.isBorderless,i=e.model,l=e.onUpdate,o=e.path,s=e.schema,c=t.useContext(Jn)
...
return r.startsWith(tr)?(i="material",r=r.substr(tr.length)):r.startsWith(er)&&(r=r.substr(er.length)),t.createElement("div",{className:Bn("tcfIcon",n,i,a)},r)}function et(e){var n=e.message,r=e.onClose
return t.createElement(t.Fragment,null,t.createElement(Xn.Content,null,t.createElement("div",{className:"tcfSynchronize--message"},t.createElement(Ze,{className:"tcfSynchronize--messageIcon error",name:"material:error",size:"huge"}),t.createElement("div",{className:"tcfSynchronize--title"},"An error has occured"),n?t.createElement("div",{className:"tcfSynchronize--message"},n):null)),t.createElement(Xn.Footer,null,t.createElement(Le,{onClick:r},"Close")))}function tt(e){var n=e.onClose
return t.createElement(t.Fragment,null,t.createElement(Xn.Content,null,t.createElement("div",{className:"tcfSynchronize--message"},t.createElement(Ze,{className:"tcfSynchronize--messageIcon finished",name:"material:check_circle",size:"huge"}),t.createElement("div",{className:"tcfSynchronize--title"},t.createElement(Ue,{value:"Sites have been synchronized"})),t.createElement("div",{className:"tcfSynchronize--message"},t.createElement(Ue,{value:"If you are not happy with the results, do not save the entry. Reload this page to revert all changes."})))),t.createElement(Xn.Footer,null,t.createElement(Le,{onClick:n},t.createElement(Ue,{value:"Close"}))))}function nt(){return[{key:"hide",label:g("Hide orphaned elements")},{key:"none",label:g("Do nothing")},{key:"remove",label:g("Remove orphaned elements")}]}function rt(){return t.createElement("div",{className:"tcfActivityIndicator"},t.createElement("div",{className:"tcfActivityIndicator--bounce first"}),t.createElement("div",{className:"tcfActivityIndicator--bounce second"}),t.createElement("div",{className:"tcfActivityIndicator--bounce third"}))}function at(){return t.createElement(Xn.Content,null,t.createElement("div",{className:"tcfSynchronize--working"},t.createElement(rt,null)))}function it(){var e,n=i.useSelector(function(e){return e.sync}),r=i.useDispatch(),a=function(){return r(T(null))}
return e="working"===n.status?t.createElement(at,null):"error"===n.status?t.createElement(et,{message:n.message,onClose:a}):"finished"===n.status?t.createElement(tt,{onClose:a}):t.createElement(ar,{onClose:a}),t.createElement(Xn,{width:600},e)}function lt(e){if(!e)return null
switch(e.type){case"create":return t.createElement(Xe,Object.assign({},e))
case"edit":return t.createElement(Zn,Object.assign({},e))
case"synchronize":return t.createElement(it,null)}}function ot(e){var n=e.children,r=t.useContext(ir)
return t.createElement(ir.Provider,{value:r+1},n)}function st(e){var n=e.disabled,r=e.dispatch,a=e.model,i=e.path,l=e.schemas.map(function(e){return{key:e.qualifier,label:e.label}})
return l.sort(Be),t.createElement(ze,{className:"tcfInstance--controlsSchema",label:"Type"},t.createElement(qe,{disabled:n,onChange:function(e){return r(O(i,e))},options:l,value:a?a.__type:null}))}function ct(e){var n=e.disabled,r=e.dispatch,a=e.model,i=a.__visible?"material:visibility":"material:visibility_off",l=t.createElement(t.Fragment,null,t.createElement(Ue,{value:"Visibility"}),t.createElement(Ze,{className:Bn("tcfInstance--controlsVisibilityIcon",{off:!a.__visible}),name:i}))
return t.createElement(ze,{label:l,className:"tcfInstance--controlsVisibility"},t.createElement(Le,{disabled:n,onClick:function(){return r(G(a.__uuid))}},t.createElement(Ue,{value:a.__visible?"Hide":"Show"})))}function ut(){var e=i.useDispatch(),n=i.useSelector(function(e){return e.model}),r=i.useSelector(function(e){return e.overlay}),a=i.useSelector(function(e){return e.config}),l=a.disabled,o=a.rootSchemas,u=a.supportedSites.length>1,d=function(){r&&!r.preventClose&&e(T(null))},f=function(){e(Q({status:"idle"})),e(T({type:"synchronize"}))}
return t.createElement(c.DndProvider,{backend:s},t.createElement(Te,null,u&&!l?t.createElement("div",{className:"tcfRoot--options"},t.createElement(je,{onClick:f,outline:!0},t.createElement(Ze,{name:"material:sync"}),t.createElement(Ue,{value:"Synchronize translations"}))):null,t.createElement(lr,{disabled:l,model:n,path:[],schemaNames:o}),r?t.createElement(or,{onClick:d},lt(r)):null))}function dt(){return{config:{apiEndpoints:{fetchSite:"",oembed:"",translate:""},disabled:!1,elementId:null,elementSiteId:0,fieldHandle:"",hasTranslator:!1,references:[],rootSchemas:[],supportedSites:[]},model:{__errors:{},__type:"unknown",__uuid:"0",__visible:!0},overlay:null,schemas:{},sync:{status:"idle"},user:{favoriteSchemas:{}}}}function ft(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:dt(),t=arguments.length>1?arguments[1]:void 0
return t.type in Fn?Fn[t.type](e,t):e}function mt(e){for(;"string"!=typeof e;)e=e.toHTML()
return e}function ht(e){var t=e.context,n=e.field,r=e.value
if(!n)return[]
var a=n.member,i=jn.getDefinition(a)
return r.map(function(e){return i.preview({value:e,field:a,context:t})})}function pt(e,t){var n={data:e.child,height:100,path:e.path,type:"MEMBER"}
return c.useDrag({item:n,begin:function(){return{data:e.child,height:t.current?t.current.clientHeight:100,path:e.path,type:"MEMBER"}},canDrag:function(){return!e.disabled},collect:function(e){return{isDragging:e.isDragging()}},isDragging:function(t){return A(e.path,t.getItem().path)}})}function vt(e,t,n){var r=n.current,a=t.getClientOffset()
if(!r||!a||!e)return null
var i=r.getBoundingClientRect(),l=i.bottom,o=i.top,s=a.y-o
return r.classList.contains("isExpanded")&&s>32&&s<l-o-32?null:(s>(l-o)/2&&(e.targetSegment=Object.assign({},e.targetSegment,{index:e.targetSegment.index+1})),e)}function yt(e,t){var n=e.path.slice(),r=n.pop()
if(!r||"index"!==r.type)return null
var a=t.path.slice(),i=a.pop()
return i&&"index"===i.type?{sourcePath:a,sourceSegment:i,targetPath:n,targetSegment:r}:null}function gt(e,t){var n=i.useStore()
return c.useDrop({accept:"MEMBER",drop:function(e){return{item:e}},hover:function(r,a){if(a.isOver({shallow:!0})){var i=vt(yt(e,r),a,t)
if(i&&R(n.getState(),i)){var l=P(i),o=I(l),s=o.targetPath,c=o.targetSegment
r.path=[].concat(_toConsumableArray(s),[c]),n.dispatch(l)}}}})}function bt(e){var n=e.child,r=e.depth,a=e.disabled,i=e.field,l=e.index,o=e.model,s=e.onDelete,c=e.onUpdate,u=e.path,d=t.useRef(null),f=_slicedToArray(pt(e,d),3),m=f[0].isDragging,h=f[1],p=f[2];(0,_slicedToArray(gt(e,d),2)[1])(d)
var v=function(){s(l)},y=function(e){c(l,e)}
return t.createElement("div",{className:Bn("tcfArrayWidgetMember depth-".concat(r),{isDragging:m}),ref:d},p(t.createElement("div",{className:"tcfArrayWidgetMember--panel tcfArrayWidgetMember--single"},h(t.createElement("div",{className:Bn("tcfArrayWidgetMember--singleHandle",{enabled:!a})},t.createElement(Ze,{className:"tcfArrayWidgetMember--singleHandleIcon",key:"handle",name:"move"}))),t.createElement("div",{className:"tcfArrayWidgetMember--singleBody"},t.createElement(Ge,{data:n,disabled:a,errors:[],field:i,model:o,onUpdate:y,path:u})),a?null:t.createElement("div",{className:"tcfArrayWidgetMember--singleActions"},t.createElement("div",{className:"tcfArrayWidgetMember--singleActionsButton",onClick:v},t.createElement(Ze,{name:"remove"}))))))}function Et(e,t){var n=t.path.slice(),r=n.pop()
...
return c.useDrop({accept:"MEMBER",drop:function(e){return{item:e}},hover:function(n,r){if(r.isOver({shallow:!0})){var a=Et(e,n)
if(a&&R(t.getState(),a)){var i=P(a),l=I(i),o=l.targetPath,s=l.targetSegment
n.path=[].concat(_toConsumableArray(o),[s]),t.dispatch(i)}}}})}function _t(e){var n=t.useRef(null)
...
return t.createElement("div",{className:Bn("tcfArrayWidgetMember--headerActionsButton",{primary:a}),onClick:function(e){e.preventDefault(),r()}},n)}function kt(){return null===ur&&(ur=new Craft.ElementThumbLoader),ur}function St(e,t){var n=t.previewImage
if(!n)return null
var r=n in e?e[n]:null
if(!Array.isArray(r)||0===r.length)return null
var a=r[0]
return"number"==typeof a?a:null}function xt(e){var n=e.className,r=e.model,a=e.schema,l=e.size,o=void 0===l?"small":l,s=t.useRef(null),c=i.useSelector(function(e){return e.config.references}),u=St(r,a),d=c.find(function(e){return e.id===u})
return t.useEffect(function(){if(s.current){var e=$(".element",s.current)
Craft.setElementSize(e,o),kt().load(e)}},[s.current,d]),d&&d.hasThumb?t.createElement("div",{className:Bn("tcfInstancePreviewImage",n,o),dangerouslySetInnerHTML:{__html:d.element},ref:s}):t.createElement("div",{className:Bn("tcfInstancePreviewImage empty",n,o)})}function Ot(e){var n=_slicedToArray(i.useSelector(function(e){return[e.config.references,e.schemas]}),2),r=n[0],a=n[1]
return t.createElement(dr,Object.assign({},e,{references:r,schemas:a}))}function Nt(e){var n=e.command,r=e.onClick
return t.createElement("div",{className:"tcfArrayWidgetMember--headerMoreItem",onMouseUp:r},t.createElement(Ze,{className:"tcfArrayWidgetMember--headerMoreItemIcon",name:n.icon}),t.createElement("span",{className:"tcfArrayWidgetMember--headerMoreItemLabel"},n.label))}function It(e){var n,r=e.commands,a=e.dispatch,i=e.onClose,l=[],o=!0,s=!1,c=void 0
try{for(var u,d=r[Symbol.iterator]();!(o=(u=d.next()).done);o=!0){(function(){var e=u.value
if("edit"===e.id)return"continue"
void 0!==n&&n!==e.group&&l.push(t.createElement("div",{className:"tcfArrayWidgetMember--headerMoreDivider",key:"".concat(e.id,"-divider")})),n=e.group,l.push(t.createElement(Nt,{command:e,key:e.id,onClick:function(){i(),e.invoke(a)}}))})()}}catch(e){s=!0,c=e}finally{try{o||null==d.return||d.return()}finally{if(s)throw c}}return t.createElement("div",{className:"tcfArrayWidgetMember--headerMoreMenu"},l)}function At(e){return e}function Rt(e,t){return t?e?"minus":"plus":e?"done":"edit"}function Mt(e){var n=e.disabled,r=e.dragSource,a=void 0===r?At:r,i=e.field,l=e.hasPreview,o=e.isCollapsible,s=e.isExpanded,c=e.model,u=e.onToggleExpanded,d=e.schema,f=[]
return d?(f.push(t.createElement(Ze,{key:"icon",name:d.icon})),d.previewImage&&f.push(t.createElement(xt,{key:"image",model:c,schema:d})),f.push(t.createElement("div",{className:Bn("tcfArrayWidgetMember--headerLabel",{isHidden:!c.__visible}),key:"label"},d.label)),l&&d.previewLabelTemplate&&f.push(t.createElement("div",{className:"tcfArrayWidgetMember--headerPreview",key:"preview"},t.createElement(Ot,{field:i,model:c})))):f.push(t.createElement(Ze,{className:"tcfArrayWidgetMember--headerHandleIcon",key:"handle",name:"move"})),t.createElement("div",{className:"tcfArrayWidgetMember--header"},a(t.createElement("div",{className:Bn("tcfArrayWidgetMember--headerHandle",{enabled:!n}),onClick:u},f)),c.__visible?null:t.createElement(Ze,{className:"tcfArrayWidgetMember--headerVisibility",name:"material:visibility_off"}),t.createElement("div",{className:"tcfArrayWidgetMember--headerActions"},o?t.createElement(wt,{onClick:u,primary:!n},t.createElement(Ze,{name:Rt(s,n)})):null,n?null:t.createElement(hr,{uuid:c.__uuid})))}function Pt(e){var n=e.className,r=e.field,a=e.model,l=e.mode,o=e.onClick,s=_slicedToArray(i.useSelector(function(e){return[e.config.references,e.schemas]}),2),c=s[0],u=s[1]
return t.createElement("div",{className:Bn("tcfInstancePreview",n,{isClickable:!!o}),onClick:o},t.createElement(pr,{field:r,model:a,mode:l,references:c,schemas:u}))}function jt(e,t){switch(e){case"always":return!0
case"root":return 1===t}}function Tt(e){var n=t.useContext(qn),r=n.isExpanded,a=n.toggleExpanded,i=t.useRef(null),l=_slicedToArray(pt(e,i),3),o=l[0].isDragging,s=l[1],c=l[2];(0,_slicedToArray(gt(e,i),2)[1])(i)
...
b=C.length>0,E=1===C.length&&"redactor"===y.fields[C[0]].type}var _,w=y&&y.preview&&jt(v,d),k=b&&(!h||r(u.__uuid))
return k?_=t.createElement("div",{className:"tcfArrayWidgetMember--body"},t.createElement(lr,{canChangeType:!1,disabled:f,isBorderless:E,key:"details",model:u,path:p,schemaNames:m.schemas})):w&&(_=t.createElement(Pt,{className:"tcfArrayWidgetMember--preview",field:m,key:"summary",model:u,onClick:b?g:void 0})),t.createElement("div",{className:Bn("tcfArrayWidgetMember depth-".concat(d),k?"isExpanded":"isCollapsed",{isDragging:o}),ref:i},c(t.createElement("div",{className:"tcfArrayWidgetMember--panel"},t.createElement(Mt,{disabled:f,dragSource:s,field:m,hasPreview:!k&&!w,isCollapsible:b&&h,isExpanded:k,model:u,onToggleExpanded:g,schema:y}),t.createElement(cr,{uri:k?"details":"summary"},_))))}function Lt(e){var n=e.children,r=e.data,a=e.disabled,l=e.field,o=e.model,s=e.onDelete,c=e.onUpdate,u=e.path,d=l.member,f=l.collapsible,m=l.previewMode,h=t.useRef(null),p=i.useSelector(function(e){return e.schemas}),v=t.useContext(ir),y=r.map(function(e,n){var r=[].concat(_toConsumableArray(u),[{index:n,name:d.name,type:"index"}]),i={child:e,depth:v,disabled:a,path:r}
return"instance"===d.type?t.createElement(Tt,Object.assign({},i,{isCollapsible:f,field:d,key:e.__uuid,previewMode:m,schema:p[e.__type]})):t.createElement(bt,Object.assign({},i,{field:d,index:n,key:xe(e)?e.__uuid:n,model:o,onDelete:s,onUpdate:c}))})
return 0===y.length&&y.push(t.createElement(_t,{field:l,key:"droplet",path:u})),t.createElement(t.Fragment,null,t.createElement("div",{className:"tcfArrayWidgetList",ref:h},y),t.createElement("div",{className:"tcfArrayWidgetList--footer"},n))}function Ut(e){if(!e)return e
if(Array.isArray(e))return e.map(function(e){return Ut(e)})
if("object"===_typeof(e)){var t={}
for(var n in e)t[n]=Ut(e[n])
return t}return e}function Ft(e){var n=e.field,r=e.onCreate,a=i.useSelector(function(e){return e.schemas})
return t.createElement("div",{className:"tcfFactory"},t.createElement(je,{className:"tcfFactory--primaryButton",onClick:function(){var e=jn.createValue({field:n,schemas:a})
r(e)},secondary:!0},t.createElement(Ze,{name:"plus"}),t.createElement(Ue,{value:"Create"})))}function Dt(e){var n=e.data,r=e.disabled,a=e.field,i=e.onUpdate
return t.createElement(Cr,{disabled:r,onChange:i,value:!!n},a.label)}function Wt(e){var t=e.red,n=e.green,r=e.blue,a=e.alpha
return{max:Math.max(t,n,r),min:Math.min(t,n,r),red:t/255,green:n/255,blue:r/255,alpha:a}}function Vt(){return{alpha:1,blue:255,green:255,red:255}}function Ht(e){return"object"===_typeof(e)&&"number"==typeof e.alpha&&"number"==typeof e.blue&&"number"==typeof e.green&&"number"==typeof e.red}function zt(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,t,n,r){return t+t+n+n+r+r})
var t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e)
return t?{red:parseInt(t[1],16),green:parseInt(t[2],16),blue:parseInt(t[3],16),alpha:1}:null}function Bt(e){var t=e.alpha,n=e.hue,r=e.saturation,a=e.value,i=0,l=0,o=0,s=Math.floor(6*n),c=6*n-s,u=a*(1-r),d=a*(1-c*r),f=a*(1-(1-c)*r)
...
case 4:i=f,l=u,o=a
break
case 5:i=a,l=u,o=d}return{alpha:t,red:Math.round(255*i),green:Math.round(255*l),blue:Math.round(255*o)}}function qt(e){return"rgba(".concat(e.red,",").concat(e.green,",").concat(e.blue,",").concat(e.alpha,")")}function $t(e){return"#"+(16777216+(e.blue|e.green<<8|e.red<<16)).toString(16).slice(1)}function Xt(e){var t=Wt(e),n=t.alpha,r=t.blue,a=t.green,i=t.max,l=t.min,o=t.red,s=0===i?0:(i-l)/i,c=(i-l)/255,u=0,d=i/255
return i===l?{hue:u,saturation:s,value:d,alpha:n}:(u=i===e.red?(a-r)/c+(a<r?6:0):i===e.green?(r-o)/c+2:(o-a)/c+4,u/=6,{hue:u,saturation:s,value:d,alpha:n})}function Gt(e){return function(n){return t.createElement(wr.Consumer,null,function(r){return t.createElement(e,Object.assign({},n,r))})}}function Yt(e){var n=e.className,r=Z(e,["className"])
return t.createElement("input",Object.assign({className:Bn("tcfInput",n)},r))}function Jt(e){var n=e.children,r=e.className,a=e.color,i=e.css,l=e.disabled,o=e.onClick,s=e.onRgbColor
if(a){var c=zt(a)
c&&(o=function(){s(c)})}return t.createElement("div",{className:Bn("tcfColorInputSwatch",r),onClick:l?void 0:o},t.createElement("div",{className:"tcfColorInputSwatch--color",style:{background:a||i}}),n)}function Kt(e){var n=e.disableAlpha,r=e.presetColors,a=[t.createElement("div",{className:"tcfColorInputPicker--value wide",key:"hex"},t.createElement(Sr,{type:"hex"}),t.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"Hex")),t.createElement("div",{className:"tcfColorInputPicker--value",key:"red"},t.createElement(Sr,{type:"red"}),t.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"R")),t.createElement("div",{className:"tcfColorInputPicker--value",key:"green"},t.createElement(Sr,{type:"green"}),t.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"G")),t.createElement("div",{className:"tcfColorInputPicker--value",key:"blue"},t.createElement(Sr,{type:"blue"}),t.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"B"))]
...
var i=null
return r&&r.length&&(i=t.createElement("div",{className:"tcfColorInputPicker--presets"},r.map(function(e){return t.createElement(Nr,{className:"tcfColorInputPicker--presetsSwatch",color:e})}))),t.createElement("div",{className:"tcfColorInputPicker"},t.createElement(xr,null),t.createElement("div",{className:"tcfColorInputPicker--controls"},t.createElement("div",{className:"tcfColorInputPicker--sliders"},t.createElement(Or,{type:"hue"}),n?null:t.createElement(Or,{type:"alpha"})),t.createElement(Nr,{className:"tcfColorInputPicker--swatch"})),t.createElement("div",{className:"tcfColorInputPicker--values"},a),i)}function Qt(e){var n=e.data,r=e.disabled,a=e.field,i=e.onUpdate,l=Ht(n)?n:Vt()
return t.createElement(Ir,{color:l,disableAlpha:!a.alpha,disabled:r,onChange:i,presetColors:a.swatches})}function Zt(e,t,n){function r(){var c=Date.now()-a
...
var c=n&&!l
return l||(l=window.setTimeout(r,t)),c&&(i=e.apply(s,o),s=o=null),i}}function en(e){var n=e.children,r=e.className,a=e.icon
return t.createElement("div",{className:Bn("tcfTextAndIcon",r)},t.createElement(Ze,{className:"tcfTextAndIcon--icon",name:a}),t.createElement(Ue,{className:"tcfTextAndIcon--text",value:n}))}function tn(e){var n=e.children,r=e.title
return t.createElement("div",{className:"tcfErrorMessage"},t.createElement(en,{icon:"material:error"},r),n)}function nn(e){return"object"===_typeof(e)&&"string"==typeof e.url}function rn(e){var n=e.favorites,r=e.onSchema,a=e.onToggleFavorite,i=e.schemas.map(function(e){var i=-1!==n.indexOf(e.qualifier)
...
return t.createElement("div",{className:"tcfSchemaList"},i)}function an(e){var n,r=e.onCreate,a=e.schemas,l=e.scope,o=_slicedToArray(t.useState(!1),2),s=o[0],c=o[1],u=i.useDispatch(),d=[],f=null
...
return t.createElement("div",{className:"tcfFactory multiple"},t.createElement(je,{className:"tcfFactory--primaryButton",onMouseDown:function(){return c(!0)}},t.createElement(Ze,{name:"plus"}),t.createElement(Ue,{value:"Create"}),s?t.createElement(mr,{onClick:function(){return c(!1)}},t.createElement(rn,{favorites:d,onSchema:h,onToggleFavorite:n,schemas:a})):null),f)}function ln(e){var n=e.onCreate,r=e.schema
return t.createElement("div",{className:"tcfFactory"},t.createElement(je,{className:"tcfFactory--primaryButton",onClick:function(){return n(r)}},t.createElement(Ze,{name:"plus"}),t.createElement(Ue,{params:{schema:r.label},value:"Create {schema}"})))}function on(e){var n=e.field,r=e.onCreate,a=e.scope,l=i.useSelector(function(e){return e.schemas}),o=n.schemas.map(function(e){return l[e]}).sort(function(e,t){return e.label.localeCompare(t.label)})
if(!o.length)return null
var s=function(e){if(-1!==o.indexOf(e))return r(w({schemas:l,schema:e}))}
return o.length>1?t.createElement(an,{onCreate:s,schemas:o,scope:a}):t.createElement(ln,{onCreate:s,schema:o[0]})}function sn(e){var n=e.children,r=e.disabled,a=e.field,l=e.model,o=t.useContext(ir),s=i.useSelector(function(e){return e.schemas}),c=t.useContext(qn),u=c.isExpanded,d=c.toggleExpanded,f=s[l.__type],m=u(l.__uuid),h=f&&f.preview,p=function(){return d(l.__uuid)},v=null
return m?v=t.createElement("div",{className:"tcfArrayWidgetMember--body"},n):h&&(v=t.createElement(Pt,{field:a,model:l})),t.createElement("div",{className:"tcfInstanceWidget--collapsiblePanel depth-".concat(o)},t.createElement(Mt,{disabled:r,field:a,hasPreview:!m&&!h,isCollapsible:!0,isExpanded:m,model:l,onToggleExpanded:p,schema:f}),t.createElement(cr,{uri:m?"details":"summary"},v))}function cn(e){var n=e.className,r=e.data,a=e.disabled,i=e.field,l=e.path,o=t.createElement(lr,{canChangeVisibility:!0,disabled:a,model:r,path:[].concat(_toConsumableArray(l),[{type:"property",name:i.name}]),schemaNames:i.schemas})
return i.collapsible&&d(r)?t.createElement(sn,{model:r,disabled:a,field:i},o):t.createElement("div",{className:Bn("tcfInstanceWidget",n)},o)}function un(e){var n=e.data,r=e.disabled,a=e.onUpdate
return t.createElement(nr,{disabled:r,onChange:a,value:!!n})}function dn(e){var t=e.data,n=e.elementType,r=e.references,a=[]
...
t&&a.push(t)}()}catch(e){l=!0,o=e}finally{try{i||null==c.return||c.return()}finally{if(l)throw o}}}return a}function fn(e){var n=t.useRef(null)
return t.useEffect(function(){var t=n.current
if(t){var r=kt(),a=!0,i=!1,l=void 0
try{for(var o,s=dn(e)[Symbol.iterator]();!(a=(o=s.next()).done);a=!0){var c=o.value.$element.clone(!1,!0)
c.appendTo(t),Craft.setElementSize(c,e.viewMode),r.load(c)}}catch(e){i=!0,l=e}finally{try{a||null==s.return||s.return()}finally{if(i)throw l}}}},[]),t.createElement("div",{className:"elementselect"},t.createElement("div",{className:"elements",ref:n}))}function mn(e){return e.disabled?t.createElement(fn,Object.assign({},e)):t.createElement(Ur,Object.assign({},e))}function hn(e){var n=e.disabled,r=e.link,a=e.linkType,i=e.onUpdate
return t.createElement("div",{className:"tcfLinkWidget--editor"},t.createElement(Fr,{criteria:a.criteria,data:[r.elementId],disabled:n,elementType:a.elementType,limit:1,onUpdate:function(e){return i(Object.assign({},r,{elementId:e.length?e[0]:0}))},sources:a.sources,viewMode:"small"}),a.allowHash?t.createElement("div",{className:"tcfLinkWidget--editorHash tcfInput--group"},t.createElement("div",{className:"tcfInput--groupLabel"},"#"),t.createElement(Yt,{disabled:n,value:r.hash,onChange:function(e){return i(Object.assign({},r,{hash:e.currentTarget.value}))}})):null)}function pn(e){var n=e.disabled,r=e.link,a=e.linkType,i=e.onUpdate
return t.createElement("div",{className:"tcfLinkWidget--editor"},t.createElement(Yt,{disabled:n,type:a.inputType,value:r.url,onChange:function(e){return i(Object.assign({},r,{url:e.currentTarget.value}))}}))}function vn(e){return"object"===_typeof(e)&&"number"==typeof e.elementId&&"string"==typeof e.hash&&"string"==typeof e.type&&"string"==typeof e.url}function yn(e){var n,r=e.data,a=e.disabled,i=e.field,l=e.onUpdate
n=vn(r)?r:{elementId:0,hash:"",openInNewWindow:!1,type:"",url:""}
var o,s=i.linkTypes[n.type]
s&&"input"===s.type?o=t.createElement(pn,{disabled:a,key:n.type,link:n,linkType:s,onUpdate:l}):s&&"element"===s.type&&(o=t.createElement(hn,{disabled:a,key:n.type,link:n,linkType:s,onUpdate:l}))
var c=i.allowNewWindow
return t.createElement("div",{className:"tcfLinkWidget"},t.createElement("div",{className:"tcfLinkWidget--type"},t.createElement(qe,{disabled:a,options:Object.keys(i.linkTypes).map(function(e){return{key:e,label:i.linkTypes[e].label}}),value:n.type,onChange:function(e){return l(Object.assign({},n,{type:e}))}})),o,c?t.createElement(Cr,{disabled:a,onChange:function(e){return l(Object.assign({},n,{openInNewWindow:e}))},value:n.openInNewWindow},t.createElement(Ue,{value:"New window"})):null)}function gn(e){var n=e.results,r=e.onSelect
return t.createElement("div",{className:""},n.map(function(e){return t.createElement("div",{onClick:function(){return r(e)}},e.formatted_address)}))}function bn(e){return"object"===_typeof(e)&&"number"==typeof e.latitude&&"number"==typeof e.longitude}function En(e,t){var n=e.dataType,r=e.defaultValue,a=e.max,i=e.min,l=e.optional,o="integer"===n?parseInt(t):parseFloat(t)
...
p(t),c(En(s,t))}function a(){f(!0)}var i=e.data,l=e.disabled,o=e.errors,s=e.field,c=e.onUpdate,u=_slicedToArray(t.useState(!1),2),d=u[0],f=u[1],m=_slicedToArray(t.useState(i),2),h=m[0],p=m[1],v=s.max,y=s.min,g=s.placeholder,b=s.unit,E=d?h:i,C=t.createElement("input",{autoComplete:"off",className:Bn("tcfNumberWidget--input text fullwidth",{error:o&&o.length}),disabled:l,max:v,min:y,onBlur:n,onChange:r,onFocus:a,placeholder:g,type:"number",value:E})
return b?t.createElement("div",{className:"tcfNumberWidget"},C,t.createElement("div",{className:"tcfNumberWidget--unit"},b)):C}function _n(e){var n=e.value
return t.createElement("div",{className:"redactor-box redactor-styles-on redactor-toolbar-on focusable-input redactor-focus focus"},t.createElement("div",{className:"redactor-styles redactor-in redactor-in-0",dangerouslySetInnerHTML:{__html:n}}))}function wn(e){return e.disabled?t.createElement(_n,Object.assign({},e)):t.createElement(Gr,Object.assign({},e))}function kn(e){var n=e.data,r=e.disabled,a=e.elementSiteId,i=e.field,l=e.onUpdate
return i.redactor?t.createElement(wn,{disabled:r,elementSiteId:a,onUpdate:l,options:i.redactor,value:n}):null}function Sn(e,t){return ee(this,void 0,void 0,regeneratorRuntime.mark(function n(){var r,a,i,l
...
n&&a.push(new Zr(n))}()}catch(e){o=!0,s=e}finally{try{l||null==u.return||u.return()}finally{if(o)throw s}}return a}function On(e){var n=e.data,r=e.disabled,a=e.field,i=e.model,l=e.onUpdate
return t.createElement(Fr,{criteria:a.criteria,disabled:r,data:n,elementType:a.elementType,limit:a.limit,modalStorageKey:"tcf_".concat(i.__type,"_").concat(a.name),onUpdate:l,sources:a.sources,viewMode:a.viewMode})}function Nn(e){var n=e.data,r=e.disabled,a=e.onUpdate,i=e.field
return t.createElement(qe,{disabled:r,onChange:a,options:i.options,value:n})}function In(e){var t
return e&&(t="color"in e?e.color:e.label),"string"==typeof t?t:"transparent"}function An(e){var n=e.data,r=e.disabled,a=e.errors,i=e.field,l=i.maxLength,o=i.minLength,s=i.placeholder,c=i.inputType,u=e.onUpdate
return t.createElement("input",{autoComplete:"off",className:Bn("tcfTextWidget text fullwidth",{error:a&&a.length}),disabled:r,maxLength:l,minLength:o,onChange:function(e){return u(e.target.value)},placeholder:s,type:c,value:n?"".concat(n):""})}function Rn(e){var n=e.data,r=e.disabled,a=e.field,i=a.maxLength,l=a.minLength,o=a.monospace,s=a.placeholder,c=a.rows,u=e.onUpdate
return t.createElement("textarea",{className:Bn("tcfTextareaWidget text fullwidth",{monospace:o}),disabled:r,maxLength:i,minLength:l,onChange:function(e){return u(e.target.value)},placeholder:s,rows:c,value:n})}r=r&&r.hasOwnProperty("default")?r.default:r,l=l&&l.hasOwnProperty("default")?l.default:l
var Mn="default"in o?o.default:o
s=s&&s.hasOwnProperty("default")?s.default:s
var Pn,jn=new(function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"initialize",value:function(e){this.definitions=e}},{key:"createValue",value:function(e){return this.getDefinition(e.field).createValue(e)}},{key:"getDefinition",value:function(e){return this.definitions["object"===_typeof(e)?e.type:e]}}]),e}()),Tn="tcfUserState",Ln={group:console.groupCollapsed,groupEnd:console.groupEnd,info:console.info,model:ae},Un={group:function(){},groupEnd:function(){},info:function(){},model:ae},Fn={addReferences:E,changeType:x,moveModel:M,setOverlay:j,setUser:L,uuidInsert:W,uuidOrder:H,uuidRemove:B,uuidVisibility:X,updateSync:K,updateValue:Y},Dn=[me,ve,pe,Ee,ge,ye,b,he,be]
!function(e){e[e.Manipulation=0]="Manipulation",e[e.Visibility=1]="Visibility",e[e.Movement=2]="Movement",e[e.Clipboard=3]="Clipboard"}(Pn||(Pn={}))
var Wn
!function(e){e[e.Idle=0]="Idle",e[e.Loading=1]="Loading",e[e.Loaded=2]="Loaded"}(Wn||(Wn={}))
var Vn,Hn=null,zn=Wn.Idle,Bn=function(e,t){return t={exports:{}},e(t,t.exports),t.exports}(function(e){!function(){function t(){for(var e=[],r=0;r<arguments.length;r++){var a=arguments[r]
...
e.exports?(t.default=t,e.exports=t):window.classNames=t}()}),qn=t.createContext({expanded:[],isExpanded:function(){return!1},toggleExpanded:function(){}})
!function(e){e.Content=Fe,e.Footer=De}(We||(We={}))
var $n,Xn=We,Gn="toolbar",Yn=[{key:"before",label:"Before selected element"},{key:"after",label:"After selected element"}]
!function(e){e[e.Small=0]="Small",e[e.Medium=1]="Medium",e[e.Large=2]="Large"}($n||($n={}))
var Jn=t.createContext($n.Large),Kn=i.connect(function(e,t){return{schema:e.schemas[t.model.__type]}},function(e,t){return{onUpdate:function(n,r){e(J(t.path,n,r))}}})(Qe),Qn=function(e){function n(e){var t
...
return t.createElement(Te,null,t.createElement(Xn,null,t.createElement(Xn.Content,null,t.createElement(Kn,{model:n,path:r})),t.createElement(Xn.Footer,null,t.createElement(Le,{onClick:this.handleApply},t.createElement(Ue,{value:"Apply"})))))}}]),n}(t.Component),Zn=i.connect(function(e,t){return m(e,t.uuid)},function(e){return{setOverlay:function(t){return e(T(t))}}})(Qn),er="craft:",tr="material:",nr=function(e){function n(){var e
...
return t.createElement("div",null,t.createElement("div",{className:Bn("lightswitch",n,{disabled:r,on:i,small:a}),ref:this.setElement,tabIndex:0},t.createElement("div",{className:"lightswitch-container"},t.createElement("div",{className:"label on"}),t.createElement("div",{className:"handle"}),t.createElement("div",{className:"label off"}))))}},{key:"updateInstance",value:function(){var e=this.element,t=this.handleChange,n=this.lightswitch,r=this.props,a=r.disabled,i=r.value
n&&(n.destroy(),this.lightswitch=null),!a&&e&&(this.lightswitch=new Craft.LightSwitch(e,{onChange:t,value:i}))}}]),n}(t.Component),rr=function(e){function n(e){var t
...
return t.createElement(t.Fragment,null,t.createElement(Xn.Content,null,t.createElement("div",{className:"tcfSynchronize--title"},t.createElement(Ue,{value:"Synchronize translations"})),t.createElement(He,null,t.createElement(ze,{instructions:g("Select the site the content should be copied from."),label:g("Site")},t.createElement(qe,{onChange:this.handleSiteChange,options:u,value:s})),t.createElement(ze,{instructions:g("Defines what happens to elements that do not exist in the selected language."),label:g("Orphaned elements")},t.createElement(qe,{onChange:this.handleArrayOrphanModeChange,options:nt(),value:o})),s&&r&&s.language!==r.language?t.createElement(ze,{instructions:g(a?"Uses a webservice to automatically translate texts.":"A matching webservice must be configured in the options of this field in order to use this feature."),label:g("Translate texts automatically")},t.createElement(nr,{disabled:!a,onChange:this.handleToggleTranslator,value:c})):null)),t.createElement(Xn.Footer,null,t.createElement(Le,{onClick:i,secondary:!0},t.createElement(Ue,{value:"Cancel"})),t.createElement(Le,{onClick:this.handleApply,primary:!0},t.createElement(Ue,{value:"Apply"}))))}}]),n}(t.Component),ar=i.connect(function(e){var t=e.config,n=t.apiEndpoints,r=t.elementSiteId,a=t.hasTranslator,i=t.supportedSites
return{availableSites:i.filter(function(e){return e.id!==r}),currentSite:i.find(function(e){return e.id===r}),endpoint:n.translate,hasTranslator:a}},function(e){return{onSynchronize:function(t){return e(de(t))}}})(rr),ir=t.createContext(0),lr=t.memo(function(e){var n=e.canChangeVisibility,r=void 0!==n&&n,a=e.canChangeType,l=void 0===a||a,o=e.disabled,s=void 0!==o&&o,c=e.isBorderless,u=e.model,f=e.path,m=e.schemaNames,h=i.useDispatch(),p=i.useSelector(function(e){return m.map(function(t){return e.schemas[t]})}),v=!1
return d(u)&&(v=p.some(function(e){return e.qualifier===u.__type})),t.createElement(ot,null,t.createElement(Ye,null,t.createElement("div",{className:"tcfInstance--controls"},l&&p.length>1?t.createElement(st,{disabled:s,dispatch:h,model:v?u:null,path:f,schemas:p}):null,r&&v&&!u.__visible?t.createElement(ct,{disabled:s,dispatch:h,model:u}):null),v?t.createElement(Kn,{disabled:s,model:u,isBorderless:c,path:f}):null))}),or=function(e){function t(e){var n
...
return t?n.createPortal(e,t):null}}]),t}(t.Component),sr=function(e){function t(e){var n
return _classCallCheck(this,t),_possibleConstructorReturn(this,(n=_getPrototypeOf(t)).call.apply(n,[this].concat(_toConsumableArray(ht(e)))))}return _inherits(t,e),_createClass(t,[{key:"toHTML",value:function(){return new o.SafeString(this.toString())}},{key:"toList",value:function(e){return new o.SafeString('<ul class="'.concat(e,'">').concat(this.map(function(e){return"<li>".concat(mt(e),"</li>")}).join(""),"</ul>"))}},{key:"toString",value:function(){return this.map(function(e){return mt(e)}).join("")}},{key:"asColumn",get:function(){return this.toList("flexColumn")}},{key:"asList",get:function(){return this.toList("")}},{key:"asRow",get:function(){return this.toList("flexRow")}}]),t}(_wrapNativeSuper(Array)),cr=function(e){function n(e){var t
...
return o&&c&&u.push(t.createElement("div",{className:Bn(r,"tcfDetailsPanel--item","from"),key:c},s)),u.push(t.createElement("div",{className:Bn(r,"tcfDetailsPanel--item",{to:o}),key:l,onAnimationEnd:this.handleAnimationEnd},i)),t.createElement("div",{className:Bn(n,"tcfDetailsPanel"),ref:this.setElement},u)}}],[{key:"getDerivedStateFromProps",value:function(e,t){return e.uri===t.currentUri?Object.assign({},t,{currentChildren:e.children}):e.uri===t.currentUri||t.inTransition?null:{inTransition:!0,lastChildren:t.currentChildren,lastUri:t.currentUri,currentChildren:e.children,currentUri:e.uri}}}]),n}(t.Component),ur=null,dr=t.memo(function(e){var n=e.field,r=e.model,a=e.references,i=e.schemas,l=Z(e,["field","model","references","schemas"]),o=mt(jn.getDefinition("instance").preview({context:{depth:0,references:a,schemas:i},field:n,mode:"label",value:r})).replace(/<[^>]*>?/gm,"").replace(/[\n\t\r]+/g,"").trim().substr(0,256)
return t.createElement("div",Object.assign({},l),o)},function(e,t){return e.model===t.model}),fr=i.connect(function(e,t){return{commands:Ce(e,t.uuid)}},function(e){return{dispatch:e}})(It),mr=function(e){function n(){var e
...
t.left="".concat(c,"px"),a.left="".concat(s,"px"),i.top+.5*i.height>.5*window.innerHeight?(o+=" above",a.top="".concat(i.top-l.height-5,"px")):(o+=" below",a.top="".concat(i.top+i.height+5,"px")),e.style.left=t.left,r.className=this.panelClassName=o,r.style.left=a.left,r.style.top=a.top}}}]),n}(t.Component),hr=function(e){function n(){var e
...
return t.createElement("div",{className:"tcfArrayWidgetMember--headerMore"},t.createElement("div",{className:"tcfArrayWidgetMember--headerMoreButton",onMouseDown:this.handleMouseDown},t.createElement(Ze,{name:"material:more_vert"})),n?t.createElement(mr,{onClick:this.handleClose},t.createElement(fr,{onClose:this.handleClose,uuid:e})):null)}}]),n}(t.Component),pr=t.memo(function(e){var n=e.field,r=e.model,a=e.mode,i=void 0===a?"default":a,l=e.references,o=e.schemas,s=jn.getDefinition("instance").preview({context:{depth:0,references:l,schemas:o},field:n,mode:i,value:r})
try{var c={__html:mt(s)}
return t.createElement("div",{className:Bn("tcfInstancePreview--content",i),dangerouslySetInnerHTML:c})}catch(e){return t.createElement(t.Fragment,null,t.createElement("p",null,t.createElement("span",{className:"tcfIcon material"},"error"),t.createElement("span",null,"Could not render preview.")),e&&"object"===_typeof(e)&&"message"in e?t.createElement("pre",null,e.message):null)}},function(e,t){return e.model===t.model}),vr=function(e){function n(){var e
...
var s,c=Array.isArray(n)?n:[],u=o>0&&c.length>=o,d=jn.getDefinition(a.member)
return r||!d||u||(s=t.createElement(d.factory,{field:a.member,onCreate:this.handleAdd,scope:i.__type})),t.createElement(Lt,{data:c,disabled:r,field:a,limit:o,model:i,onDelete:this.handleDelete,onUpdate:this.handleUpdate,path:l},s)}}]),n}(t.Component)
vr.contextType=qn
var yr,gr=function(){function e(t){var n=t.factory,r=t.widget
_classCallCheck(this,e),this.factory=n||Ft,this.widget=r}return _createClass(e,[{key:"cloneValue",value:function(e){return ee(this,void 0,void 0,regeneratorRuntime.mark(function t(){var n,r
...
case 6:case"end":return t.stop()}},t,this)}))}}]),e}(),br=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:vr}))}return _inherits(t,e),_createClass(t,[{key:"cloneValue",value:function(e){return ee(this,void 0,void 0,regeneratorRuntime.mark(function t(){var n,r,a,i,l,o,s,c,u,d,f
...
break}i=jn.getDefinition(n.member.type),l=[],o=!0,s=!1,c=void 0,t.prev=7,u=r[Symbol.iterator]()
...
case 37:case"end":return t.stop()}},t,this,[[7,21,25,33],[26,,28,32]])}))}},{key:"createValue",value:function(e){return[]}},{key:"isValue",value:function(e,t){return Array.isArray(t)}},{key:"preview",value:function(e){return new sr(e)}}]),t}(gr),Er=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){return!!e.field.defaultValue}},{key:"isValue",value:function(e,t){return"boolean"==typeof t||t instanceof Boolean}},{key:"preview",value:function(e){return e.value}}]),t}(gr),Cr=function(e){function n(){var e
...
return t.createElement("dl",{className:Bn("tcfCheckbox",r)},t.createElement("dd",{className:"tcfCheckbox--input"},t.createElement("input",{checked:o,disabled:i,id:e,onChange:i?void 0:function(){return l(!o)},type:"checkbox"})),t.createElement("dt",{className:"tcfCheckbox--label"},t.createElement("label",{htmlFor:e},a)))}}]),n}(t.Component),_r=function(e){function t(){var e
return _classCallCheck(this,t),e=_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Dt})),e.isAlwaysPlainField=!0,e}return _inherits(t,e),t}(Er),wr=t.createContext({css:"#000",hsv:{hue:0,saturation:0,value:0,alpha:0},rgb:{red:0,green:0,blue:0,alpha:0},onHsvColor:function(e){},onRgbColor:function(e){}}),kr=function(e){function n(e){var t
return _classCallCheck(this,n),t=_possibleConstructorReturn(this,_getPrototypeOf(n).call(this,e)),t.timeout=null,t.commit=function(){null!==t.timeout&&window.clearTimeout(t.timeout),t.timeout=window.setTimeout(t.handleTimeout,250)},t.handleHsvColor=function(e){var n=Bt(e)
t.setState({css:qt(n),rgb:n,hsv:e}),t.commit()},t.handleRgbColor=function(e){t.setState({css:qt(e),rgb:e,hsv:Xt(e)}),t.commit()},t.handleTimeout=function(){t.timeout=null,t.props.onChange(t.state.rgb)},t.state={css:qt(e.color),hsv:Xt(e.color),rgb:Object.assign({},e.color)},t}return _inherits(n,e),_createClass(n,[{key:"render",value:function(){var e=this.props.children
return t.createElement(wr.Provider,{value:Object.assign({},this.state,{onHsvColor:this.handleHsvColor,onRgbColor:this.handleRgbColor})},e)}}]),n}(t.Component),Sr=Gt(function(e){function n(){var e
...
case"hex":return $t(t)}}},{key:"getColor",value:function(e){var t=this.props,n=t.rgb,r=t.type
...
return e?n.defaultValue=this.getValue():n.value=this.getValue(),t.createElement(Yt,n)}}]),n}(t.Component)),xr=Gt(function(e){function n(){var e
...
return l({alpha:i.alpha,hue:n,saturation:s,value:1-c}),{mouseX:s,mouseY:c}}}]),n}(t.Component)),Or=Gt(function(e){function n(){var e
...
a(Object.assign({},r,_defineProperty({},i,o)))}}}]),n}(t.Component)),Nr=Gt(Jt),Ir=function(e){function n(){var e
...
return t.createElement(kr,{color:r,onChange:l},t.createElement("div",{className:"tcfColorInput"},t.createElement(Nr,{className:"tcfColorInput--swatch",disabled:i,onClick:this.handleSwatchClick},e&&!i?t.createElement(mr,{onClick:this.handleOverlayClick},t.createElement(Kt,{disableAlpha:a,presetColors:o})):null),t.createElement(Sr,{type:"hex"})))}}]),n}(t.Component),Ar=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Qt}))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){return Vt()}},{key:"isValue",value:function(e,t){return Ht(t)}},{key:"preview",value:function(e){e.context,e.value
return""}}]),t}(gr),Rr=function(e){function n(){var e
return _classCallCheck(this,n),e=_possibleConstructorReturn(this,_getPrototypeOf(n).apply(this,arguments)),e.request=null,e.state={mode:"idle"},e.handleChange=function(t){e.updateOEmbed(),e.setState({mode:"typing"}),e.props.onUpdate(Object.assign({},e.getOEmbed(),{url:t.target.value}))},e.updateOEmbed=Zt(function(){e.setState({mode:"loading"})
...
return nn(e)?e:{url:""}}},{key:"handleRequestStateChange",value:function(e){if(e.readyState===XMLHttpRequest.DONE){if(200!==e.status)return this.handleRequestError()
var t
...
return e&&e.thumbnail_url?new o.SafeString('<img width="100" src='.concat(e.thumbnail_url," />")):""}},{key:"title",get:function(){return this.value.info?this.value.info.title:""}}]),e}(),jr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Mr}))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){return{url:""}}},{key:"isValue",value:function(e,t){return nn(t)}},{key:"preview",value:function(e){var t=e.value
return new Pr(nn(t)?t:{url:""})}}]),t}(gr),Tr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{factory:on,widget:cn}))}return _inherits(t,e),_createClass(t,[{key:"cloneValue",value:function(e){return ee(this,void 0,void 0,regeneratorRuntime.mark(function t(){var n,r,a
...
s.depth=t.depth
for(var c=0,u=Object.keys(i.fields);c<u.length;c++){var f=u[c],m=i.fields[f],h=jn.getDefinition(m)
h&&(s[f]=h.preview({context:Object.assign({},t,{depth:t.depth+1}),field:m,value:a[f]}))}return s}}]),t}(gr),Lr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:un}))}return _inherits(t,e),t}(Er),Ur=function(e){function n(){var e
...
if(!e)return[]
for(var t=[],n=e.getSelectedElementIds(),r=e.getElements(),a=0;a<r.length;a++){var i=parseInt(r.eq(a).data("id"));-1!==n.indexOf(i)&&t.push(i)}return t}},{key:"render",value:function(){return t.createElement("div",{id:this.uuid,className:"elementselect",ref:this.setElement},t.createElement("div",{className:"elements"}),t.createElement("div",{className:"btn add icon dashed"},"Choose"))}}]),n}(t.Component),Fr=i.connect(function(e){return{references:e.config.references,sourceElementId:e.config.elementId}},function(e){return{onAddReferences:function(t){e(C(t))}}})(mn),Dr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:yn}))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(){return{elementId:0,openInNewWindow:!1,type:"url",url:""}}},{key:"isValue",value:function(e,t){return vn(t)}},{key:"preview",value:function(){return""}}]),t}(gr),Wr=function(){function e(t){_classCallCheck(this,e),this.latitude=t.latitude,this.longitude=t.longitude}return _createClass(e,[{key:"createStaticMap",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:100,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:75,n=this.latitude,r=this.longitude,a=ke()
...
return new o.SafeString('\n      <img src="https://maps.googleapis.com/maps/api/staticmap?'.concat(i,'" width="').concat(e,'" height="').concat(t,'" />\n    '))}},{key:"toHTML",value:function(){return this.createStaticMap()}}]),e}(),Vr=["address","street","country","zip","city"],Hr=function(e){function n(){var e
...
r&&0===r.length?n=t.createElement(en,{icon:"material:error"},"No locations found"):r&&(n=t.createElement(gn,{onSelect:this.handleResultsSelect,results:r})),e=t.createElement("div",{className:"tcfLocationFieldSearch--resolve"},n?t.createElement(mr,{onClick:this.handleResultsCancel},n):null,t.createElement(Le,{onClick:this.handleResolve},t.createElement(Ue,{value:"Resolve address"})))}return t.createElement("div",{className:"tcfLocationFieldSearch"},e,t.createElement("input",{className:"tcfLocationFieldSearch--input tcfInput",ref:this.setInput,type:"search"}))}}]),n}(t.Component),zr=17
!function(e){e[e.Loading=0]="Loading",e[e.Error=1]="Error",e[e.Ready=2]="Ready"}(yr||(yr={}))
var Br=function(e){function n(){var e
return _classCallCheck(this,n),e=_possibleConstructorReturn(this,_getPrototypeOf(n).apply(this,arguments)),e.element=null,e.marker=null,e.state={instance:null,loadState:yr.Loading},e.handleLocation=function(t){var n=e.state.instance
n&&(n.map.setZoom(zr),n.map.setCenter({lat:t.latitude,lng:t.longitude})),e.props.onUpdate(t)},e.handleMarkerDragEnd=function(){var t=_assertThisInitialized(e).marker
...
var l=a.map
l.setZoom(zr),l.setCenter(e.getLatLng()),(i=new google.maps.Marker({draggable:!r,position:e.getLatLng(),map:l})).addListener("dragend",e.handleMarkerDragEnd)}e.element=t,e.marker=i,e.setState({instance:a})},e}return _inherits(n,e),_createClass(n,[{key:"componentDidUpdate",value:function(e){var t=this.marker
...
return bn(e)?{lat:e.latitude,lng:e.longitude}:{lat:0,lng:0}}},{key:"render",value:function(){var e=this.state,n=e.loadState,r=e.instance,a=this.props,i=a.disabled,l=a.model,o=this.marker
o&&o.setPosition(this.getLatLng())
var s
return s=n===yr.Loading?t.createElement(rt,null):n===yr.Error?t.createElement(tn,{title:"Could not load Google Maps"}):t.createElement(t.Fragment,null,i?null:t.createElement(Hr,{model:l,onLocation:this.handleLocation,places:r?r.places:null}),t.createElement("div",{className:"tcfLocation--map",ref:this.setElement})),t.createElement("div",{className:"tcfLocation"},s)}}],[{key:"createInstance",value:function(){var e=this.instanceStash.pop()
...
Br.instanceStash=[]
var qr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Br}))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){var t=e.field
return bn(t.defaultValue)?Object.assign({},t.defaultValue):{latitude:0,longitude:0}}},{key:"isValue",value:function(e,t){return bn(t)}},{key:"preview",value:function(e){var t=e.value
return new Wr(t)}}]),t}(gr),$r=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Cn}))}return _inherits(t,e),t}(function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"cloneValue",value:function(e){return ee(this,void 0,void 0,regeneratorRuntime.mark(function t(){var n,r,a
...
case 2:case"end":return t.stop()}},t,this)}))}},{key:"createValue",value:function(e){return e.field.defaultValue}},{key:"isValue",value:function(e,t){return!(!e.optional||null!==t)||("number"==typeof t||t instanceof Number)}},{key:"preview",value:function(e){return e.value}}]),t}(gr)),Xr=function(){function e(t){_classCallCheck(this,e),this.value=t}return _createClass(e,[{key:"toHTML",value:function(){return new o.SafeString(this.value)}},{key:"summary",get:function(){return new o.SafeString('<div class="snippet">'.concat(this.value,"</div>"))}}]),e}(),Gr=function(e){function n(){var e
...
return t.createElement("div",{className:"tcfRedactorWidget"},t.createElement("textarea",{defaultValue:"string"==typeof e?e:"",id:this.uuid,ref:this.setElement}))}}]),n}(t.Component),Yr=i.connect(function(e){return{elementSiteId:e.config.elementSiteId}})(kn),Jr=0,Kr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"cloneValue",value:function(e){return ee(this,void 0,void 0,regeneratorRuntime.mark(function t(){var n,r,a
...
break}return t.abrupt("return",Sn(a,r))
case 6:return t.abrupt("return",a)
case 7:t.next=10
break
case 9:return t.abrupt("return","")
case 10:case"end":return t.stop()}},t,this)}))}},{key:"createValue",value:function(e){return""}},{key:"isValue",value:function(e,t){return"string"==typeof t||t instanceof String}},{key:"preview",value:function(e){return e.value}}]),t}(gr),Qr=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Yr}))}return _inherits(t,e),_createClass(t,[{key:"preview",value:function(e){var t=e.value
return new Xr(t)}}]),t}(Kr),Zr=function(){function e(t){_classCallCheck(this,e),this.reference=t}return _createClass(e,[{key:"createPreview",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"large",t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=this.reference.$element.clone(!1,!0)
...
if(!e)return null
var t=e.split(",").pop()
return t?new o.SafeString('<div class="tcfInstancePreview--background" style="background-image: url(\''.concat(t.trim(),'\');"></div><div class="tcfInstancePreview--background blur" style="background-image: url(\'').concat(t.trim(),"');\"></div>")):null}},{key:"asLargeElement",get:function(){return this.createSafePreview("large",!1)}},{key:"asLargeImage",get:function(){return this.createSafePreview("large",!0)}},{key:"asSmallElement",get:function(){return this.createSafePreview("small",!1)}},{key:"asSmallImage",get:function(){return this.createSafePreview("small",!0)}},{key:"label",get:function(){return this.reference.label}}]),e}(),ea=function(e){function t(e){var n
return _classCallCheck(this,t),_possibleConstructorReturn(this,(n=_getPrototypeOf(t)).call.apply(n,[this].concat(_toConsumableArray(xn(e)))))}return _inherits(t,e),_createClass(t,[{key:"toHTML",value:function(){return new o.SafeString('<div class="tcfInstancePreview--elements">'.concat(this.toString(),"</div>"))}},{key:"toString",value:function(){for(var e=[],t=0;t<this.length;t++)e.push(mt(this[t]))
return e.join("")}},{key:"asBackground",get:function(){return this.length?this[0].asBackground:null}},{key:"asLargeElement",get:function(){return this.length?this[0].asLargeElement:null}},{key:"asLargeImage",get:function(){return this.length?this[0].asLargeImage:null}},{key:"asSmallElement",get:function(){return this.length?this[0].asSmallElement:null}},{key:"asSmallImage",get:function(){return this.length?this[0].asSmallImage:null}},{key:"firstLabel",get:function(){return this.length?this[0].label:""}},{key:"label",get:function(){return this.map(function(e){return e.label}).join(", ")}}]),t}(_wrapNativeSuper(Array)),ta=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:On}))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){return[]}},{key:"isValue",value:function(e,t){return Array.isArray(t)&&t.every(function(e){return"number"==typeof e})}},{key:"preview",value:function(e){return new ea(e)}}]),t}(gr),na=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"createValue",value:function(e){var t=e.field
...
return r?r.label:"-"}}]),t}(gr),ra=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Nn}))}return _inherits(t,e),t}(na),aa=function(e){function n(){var e
...
return t.createElement("div",{className:Bn("tcfSwatchColorWidget",{isUndecided:!l}),onClick:r?void 0:this.handleSwatchClick,style:{background:l?In(l):void 0}},i&&!r?this.renderFlyout(l):null)}},{key:"renderFlyout",value:function(e){var n=this,r=this.props.field
return t.createElement(mr,{onClick:this.handleFlyoutClick},t.createElement("div",{className:"tcfSwatchColorWidget--swatches"},r.options.map(function(r){return t.createElement("div",{className:Bn("tcfSwatchColorWidget--swatch",{isSelected:r===e}),key:r.key,onClick:function(){return n.handleSelect(r)},style:{background:In(r)}})})))}}]),n}(t.Component),ia=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:aa}))}return _inherits(t,e),t}(na),la=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:An}))}return _inherits(t,e),t}(Kr),oa=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,_getPrototypeOf(t).call(this,{widget:Rn}))}return _inherits(t,e),t}(Kr)
jn.initialize({array:new br,checkbox:new _r,color:new Ar,instance:new Tr,lightswitch:new Lr,link:new Dr,location:new qr,number:new $r,oembed:new jr,redactor:new Qr,reference:new ta,select:new ra,swatchcolor:new ia,text:new la,textarea:new oa})
var sa=[],ca={},ua={create:function(e){try{var l=null,o=document.getElementById(e)
...
var d=a.createStore(ft,Pe(c,u),a.applyMiddleware(r))
sa.push(d),d.subscribe(function(){var e=window.draftEditor,t=JSON.stringify(d.getState().model)
u.value!==t&&e&&(l&&window.clearTimeout(l),l=window.setTimeout(function(){e.checkForm(),l=null},500)),u.value=t}),n.render(t.createElement(i.Provider,{store:d},t.createElement(ut,null)),s)}catch(e){console.error("Could not start content editor: "+e.message)}},getInstanceApi:function(e){for(var t=0,n=sa;t<n.length;t++){var r=n[t],a=m(r.getState(),e)
return a?_e(r,a):null}},getValidator:function(e){return e in ca?ca[e]:null},registerValidator:function(e,t){ca[e]=t}}
return ua}(_babelPolyfill,React,ReactDOM,ReduxThunk,Redux,ReactRedux,jQuery,Handlebars,ReactDnDHTML5Backend,ReactDnD)
