...
return s.createElement(vn.Provider,{value:Object.assign(Object.assign({},this.state),{onHsvColor:this.handleHsvColor,onRgbColor:this.handleRgbColor})},e)}}function wn(e){var{className:t}=e,n=(0,W.Tt)(e,["className"])
...
return e?t.defaultValue=this.getValue():t.value=this.getValue(),s.createElement(wn,t)}}const Sn=bn(Cn)
class xn extends s.Component{constructor(){super(...arguments),this.element=null,this.state={initialHue:0,isMouseDown:!1,mouseX:0,mouseY:0},this.handleMouseDown=e=>{const{hsv:t}=this.props
...
return a({alpha:r.alpha,hue:n,saturation:l,value:1-o}),{mouseX:l,mouseY:o}}}const On=bn(xn)
...
function jn({disableAlpha:e,presetColors:t}){const n=[s.createElement("div",{className:"tcfColorInputPicker--value wide",key:"hex"},s.createElement(Sn,{type:"hex"}),s.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"Hex")),s.createElement("div",{className:"tcfColorInputPicker--value",key:"red"},s.createElement(Sn,{type:"red"}),s.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"R")),s.createElement("div",{className:"tcfColorInputPicker--value",key:"green"},s.createElement(Sn,{type:"green"}),s.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"G")),s.createElement("div",{className:"tcfColorInputPicker--value",key:"blue"},s.createElement(Sn,{type:"blue"}),s.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"B"))]
e||n.push(s.createElement("div",{className:"tcfColorInputPicker--value",key:"alpha"},s.createElement(Sn,{type:"alpha"}),s.createElement("div",{className:"tcfColorInputPicker--valueCaption"},"A")))
let r=null
return t&&t.length&&(r=s.createElement("div",{className:"tcfColorInputPicker--presets"},t.map((e=>s.createElement(kn,{className:"tcfColorInputPicker--presetsSwatch",color:e}))))),s.createElement("div",{className:"tcfColorInputPicker"},s.createElement(On,null),s.createElement("div",{className:"tcfColorInputPicker--controls"},s.createElement("div",{className:"tcfColorInputPicker--sliders"},s.createElement(Nn,{type:"hue"}),e?null:s.createElement(Nn,{type:"alpha"})),s.createElement(kn,{className:"tcfColorInputPicker--swatch"})),s.createElement("div",{className:"tcfColorInputPicker--values"},n),r)}class In extends s.Component{constructor(){super(...arguments),this.state={hasColorPicker:!1},this.handleChange=e=>{this.props.onChange(e)},this.handleSwatchClick=()=>{this.setState({hasColorPicker:!0})},this.handleOverlayClick=()=>{this.setState({hasColorPicker:!1})}}render(){const{hasColorPicker:e}=this.state,{color:t,disableAlpha:n,disabled:r,onChange:a,presetColors:i}=this.props
return s.createElement(En,{color:t,onChange:a},s.createElement("div",{className:"tcfColorInput"},s.createElement(kn,{className:"tcfColorInput--swatch",disabled:r,onClick:this.handleSwatchClick},e&&!r?s.createElement(Gt,{onClick:this.handleOverlayClick},s.createElement(jn,{disableAlpha:n,presetColors:i})):null),s.createElement(Sn,{type:"hex"})))}}function Mn({data:e,disabled:t,field:n,onUpdate:r}){const a=pn(e)?e:{alpha:1,blue:255,green:255,red:255}
return s.createElement(In,{color:a,disableAlpha:!n.alpha,disabled:t,onChange:r,presetColors:n.swatches})}function Ln({children:e,className:t,icon:n}){return s.createElement("div",{className:je()("tcfTextAndIcon",t)},s.createElement(He,{className:"tcfTextAndIcon--icon",name:n}),s.createElement(Pe,{className:"tcfTextAndIcon--text",value:e}))}function An({children:e,title:t}){return s.createElement("div",{className:"tcfErrorMessage"},s.createElement(Ln,{icon:"material:error"},t),e)}class Pn extends s.Component{constructor(){super(...arguments),this.request=null,this.state={mode:"idle"},this.handleChange=e=>{this.updateOEmbed(),this.setState({mode:"typing"}),this.props.onUpdate(Object.assign(Object.assign({},this.getOEmbed()),{url:e.target.value}))},this.updateOEmbed=function(e,t,n){let s,r,a=null,i=null,l=null
...
return r.collapsible&&c(t)?s.createElement(Vn,{model:t,disabled:n,field:r},i):s.createElement("div",{className:je()("tcfInstanceWidget",e)},i)}function Wn(e){var{attribute:t,column:n,max:r,min:a,onUpdate:i}=e,l=(0,W.Tt)(e,["attribute","column","max","min","onUpdate"])
...
return g("Column {num}",{num:`${t}${n>1?n:""}`})}function Xn(e){var{columns:t,columnsPerRow:n,isSelected:r,onClick:a}=e,i=(0,W.Tt)(e,["columns","columnsPerRow","isSelected","onClick"])
...
return Math.round(e/r)}}function Gn(e){var{columns:t,selected:n}=e,r=(0,W.Tt)(e,["columns","selected"])
...
function h(e){d(e===u?null:e)}return s.createElement(Ue,null,s.createElement(Ue.Content,null,s.createElement("div",{className:"tcfLayoutEditor--title"},s.createElement(Pe,{value:"Edit columns"})),i.map((e=>s.createElement(Qn,Object.assign({},a,{current:e,key:e.key,selected:m,onSelect:h}))))),s.createElement(Ue.Footer,null,s.createElement("div",{className:"btngroup"},l.length<o?s.createElement(Ae,{onClick:()=>d(n())},s.createElement(He,{name:"plus"}),s.createElement(Pe,{value:"Create"})):null,m&&l.length>c?s.createElement(Ae,{onClick:()=>r(m.__uuid)},s.createElement(He,{name:"minus"}),s.createElement(Pe,{value:"Delete"})):null),s.createElement(Ae,{onClick:t,primary:!0},s.createElement(Pe,{value:"Close"}))))}function Zn(e){var{onClose:t,onPreset:n,preset:r,presets:a}=e,i=(0,W.Tt)(e,["onClose","onPreset","preset","presets"])
return s.createElement(Gt,{onClick:t},s.createElement("div",{className:"tcfLayoutSelect--flyout"},a.map((e=>s.createElement(Xn,Object.assign({},i,{columns:e.columns,isSelected:e.key===r,key:e.key,onClick:()=>n(e)}))))))}function es(e){var{canEdit:t,onPreset:n,preset:r,presets:a}=e,i=(0,W.Tt)(e,["canEdit","onPreset","preset","presets"])
...
n.append(r),s.load($(r))}}),[]),s.createElement("div",{className:"elementselect"},s.createElement("ul",{className:S(e.viewMode),ref:t}))}class as extends s.Component{constructor(){super(...arguments),this.element=null,this.rendered=[],this.uuid=`element-${_()}`,this.instance=null,this.isRendering=!1,this.handleAdd=({elements:e})=>{const{onAddReferences:t}=this.props
...
let ls=0
function os(e){var{className:t,suggestions:n}=e,r=(0,W.Tt)(e,["className","suggestions"])
const[a]=s.useState("tcfAutoCompleteList_"+ls++)
return s.createElement(s.Fragment,null,s.createElement("input",Object.assign({className:je()("tcfInput",t),list:a},r)),s.createElement("datalist",{id:a},n.map(((e,t)=>s.createElement("option",{key:t},e)))))}function cs(e){var{apiEndpoint:t}=e,n=(0,W.Tt)(e,["apiEndpoint"])
...
return new ge.SafeString(`\n      <img src="${a}" width="${e}" height="${t}" />\n    `)}toHTML(){return this.createStaticMap()}}function vs({results:e,onSelect:t}){return s.createElement("div",{className:""},e.map((e=>s.createElement("div",{onClick:()=>t(e)},e.formatted_address))))}(0,W.Cg)([_t],ys.prototype,"latitude",void 0),(0,W.Cg)([_t],ys.prototype,"longitude",void 0),(0,W.Cg)([Ot],ys.prototype,"createStaticMap",null),(0,W.Cg)([Ot],ys.prototype,"toHTML",null)
const bs=["address","street","country","zip","city"]
class Es extends s.Component{constructor(){super(...arguments),this.autocomplete=null,this.input=null,this.state={isSearching:!1},this.handlePlaceChanged=()=>{const{autocomplete:e}=this
if(!e)return
const t=e.getPlace()
...
for(const n of bs)n in e&&"string"==typeof e[n]&&t.push(e[n].trim())
return t.join(", ")}render(){let e
if(this.canResolve()){const{results:t}=this.state
let n
t&&0===t.length?n=s.createElement(Ln,{icon:"material:error"},"No locations found"):t&&(n=s.createElement(vs,{onSelect:this.handleResultsSelect,results:t})),e=s.createElement("div",{className:"tcfLocationFieldSearch--resolve"},n?s.createElement(Gt,{onClick:this.handleResultsCancel},n):null,s.createElement(Ae,{onClick:this.handleResolve},s.createElement(Pe,{value:"Resolve address"})))}return s.createElement("div",{className:"tcfLocationFieldSearch"},e,s.createElement("input",{className:"tcfLocationFieldSearch--input tcfInput",ref:this.setInput,type:"search"}))}}function ws(e){return"object"==typeof e&&"number"==typeof e.latitude&&"number"==typeof e.longitude}var Cs
!function(e){e[e.Loading=0]="Loading",e[e.Error=1]="Error",e[e.Ready=2]="Ready"}(Cs||(Cs={}))
class Ss extends s.Component{constructor(){super(...arguments),this.element=null,this.marker=null,this.state={instance:null,loadState:Cs.Loading},this.handleLocation=e=>{const{instance:t}=this.state
...
if(n&&(Ss.stashInstance(n),n=null),s&&(s.setMap(null),s.unbindAll(),s=null),e){n=Ss.createInstance(),e.appendChild(n.element)
const{map:r}=n
...
t.src=`https://maps.googleapis.com/maps/api/js?key=${ve}&libraries=places&callback=onGoogleMapsReady`,(document.head||document.body).appendChild(t),Ee=fe.Loading})))).then((()=>{this.setState({loadState:Cs.Ready})}))}catch(e){this.setState({loadState:Cs.Error})}}getLatLng(){const{data:e}=this.props
return ws(e)?{lat:e.latitude,lng:e.longitude}:{lat:0,lng:0}}render(){const{loadState:e,instance:t}=this.state,{disabled:n,model:r}=this.props,{marker:a}=this
let i
return a&&a.setPosition(this.getLatLng()),i=e===Cs.Loading?s.createElement(dt,null):e===Cs.Error?s.createElement(An,{title:"Could not load Google Maps"}):s.createElement(s.Fragment,null,n?null:s.createElement(Es,{model:r,onLocation:this.handleLocation,places:t?t.places:null}),s.createElement("div",{className:"tcfLocation--map",ref:this.setElement})),s.createElement("div",{className:"tcfLocation"},i)}static createInstance(){let e=this.instanceStash.pop()
...
n&&n.removeChild(t),this.instanceStash.push(e)}}Ss.instanceStash=[]
const xs=Ss
function Os({data:e,disabled:t,errors:n,field:r,onUpdate:a}){const[i,l]=s.useState(!1),[o,c]=s.useState(e),{max:u,min:d,placeholder:m,unit:h}=r,p=i?o:e
...
return h?s.createElement("div",{className:"tcfNumberWidget"},f,s.createElement("div",{className:"tcfNumberWidget--unit"},h)):f}class _s extends cn{cloneValue(e){return(0,W.sH)(this,void 0,void 0,(function*(){const{field:t,schemas:n,value:s}=e
return this.isValue(t,s)?s:this.createValue({field:t,schemas:n})}))}createValue({field:e}){return e.defaultValue}isValue({optional:e},t){return!(!e||null!==t)||("number"==typeof t||t instanceof Number)}preview({value:e}){return e}}class Ns{constructor(e){this.value=e}get summary(){return new ge.SafeString(`<div class="snippet">${this.value}</div>`)}toHTML(){return new ge.SafeString(this.value)}}function ks({value:e}){return s.createElement("div",{className:"redactor-box redactor-styles-on redactor-toolbar-on focusable-input redactor-focus focus"},s.createElement("div",{className:"redactor-styles redactor-in redactor-in-0",dangerouslySetInnerHTML:{__html:e}}))}(0,W.Cg)([_t],Ns.prototype,"value",void 0),(0,W.Cg)([_t],Ns.prototype,"summary",null),(0,W.Cg)([Ot],Ns.prototype,"toHTML",null)
class js extends s.Component{constructor(){super(...arguments),this.element=null,this.hasFocus=!1,this.instance=null,this.renderedValue="",this.uuid=`element-${_()}`,this.handleBlur=()=>{this.hasFocus=!1},this.handleChange=(e,...t)=>{this.hasFocus&&(this.renderedValue=e,this.props.onUpdate(e))},this.handleFocus=()=>{this.hasFocus=!0},this.setElement=e=>{if(this.element===e)return
this.element=e
...
return s.createElement("div",{className:"tcfRedactorWidget"},s.createElement("textarea",{defaultValue:"string"==typeof e?e:"",id:this.uuid,ref:this.setElement}))}}function Is(e){return e.disabled?s.createElement(ks,Object.assign({},e)):s.createElement(js,Object.assign({},e))}const Ms=(0,l.Ng)((e=>({elementSiteId:e.config.elementSiteId})))((function({data:e,disabled:t,elementSiteId:n,field:r,onUpdate:a}){return r.redactor?s.createElement(Is,{disabled:t,elementSiteId:n,onUpdate:a,options:r.redactor,value:e}):null}))
let Ls=0
class As extends cn{cloneValue(e){return(0,W.sH)(this,void 0,void 0,(function*(){const{field:t,translate:n,value:s}=e
return this.isValue(t,s)?t.translatable&&n?function(e,t){return(0,W.sH)(this,void 0,void 0,(function*(){if(Ls>2)return console.warn(`Translator has returned to many errors, skipping translation for text "${e}".`),e
...
return Object.keys(a).forEach((e=>i.append(e,a[e]))),new Promise((t=>{fetch(n,{body:i,method:"post"}).then((e=>e.json())).then((n=>{t(n&&n.data?n.data:e)})).catch((n=>{console.error(`Translator returned an error: ${n}`),Ls+=1,t(e)}))}))}))}(s,n):s:""}))}createValue(e){return""}isValue(e,t){return"string"==typeof t||t instanceof String}preview({value:e}){return e}}class Ps{constructor(e){this.reference=e}createPreview(e="large",t=!0){const n=E(this.reference,"large"===e?"large":"list")
if(!n)return""
...
if(!t)return null
const n=t.split(",").pop()
return n?new ge.SafeString(`<div class="tcfInstancePreview--background" style="background-image: url('${n.trim()}');"></div><div class="tcfInstancePreview--background blur" style="background-image: url('${n.trim()}');"></div>`):null}get asLargeElement(){return this.createSafePreview("large",!1)}get asLargeImage(){return this.createSafePreview("large",!0)}get asSmallElement(){return this.createSafePreview("small",!1)}get asSmallImage(){return this.createSafePreview("small",!0)}get label(){return this.reference.label}toHTML(){return new ge.SafeString(this.toString())}toString(){return this.createPreview()}}(0,W.Cg)([_t],Ps.prototype,"reference",void 0),(0,W.Cg)([Ot],Ps.prototype,"createPreview",null),(0,W.Cg)([Ot],Ps.prototype,"createSafePreview",null),(0,W.Cg)([_t],Ps.prototype,"asBackground",null),(0,W.Cg)([_t],Ps.prototype,"asLargeElement",null),(0,W.Cg)([_t],Ps.prototype,"asLargeImage",null),(0,W.Cg)([_t],Ps.prototype,"asSmallElement",null),(0,W.Cg)([_t],Ps.prototype,"asSmallImage",null),(0,W.Cg)([_t],Ps.prototype,"label",null),(0,W.Cg)([Ot],Ps.prototype,"toHTML",null),(0,W.Cg)([Ot],Ps.prototype,"toString",null)
class Ts extends Array{constructor(e){super(...function({context:{references:e},field:t,value:n}){const s=[]
if(!t)return s
const{elementType:r}=t
for(const t of n){const n=e.find((e=>C(e,t)&&e.type===r))
n&&s.push(new Ps(n))}return s}(e))}get asBackground(){return this.length?this[0].asBackground:null}get asLargeElement(){return this.length?this[0].asLargeElement:null}get asLargeImage(){return this.length?this[0].asLargeImage:null}get asSmallElement(){return this.length?this[0].asSmallElement:null}get asSmallImage(){return this.length?this[0].asSmallImage:null}get firstLabel(){return this.length?this[0].label:""}get label(){return this._map((e=>e.label)).join(", ")}toHTML(){return new ge.SafeString(`<div class="tcfInstancePreview--elements">${this.toString()}</div>`)}toString(){return this._map((e=>Ct(e))).join("")}_map(e){const t=[]
for(let n=0;n<this.length;n++)t.push(e(this[n],n))
return t}}function $s({data:e,disabled:t,field:n,model:r,onUpdate:a}){return s.createElement(is,{allowSelfReference:n.allowSelfReference,condition:n.condition,criteria:n.criteria,disabled:t,data:e,elementType:n.elementType,limit:n.limit||null,modalStorageKey:n.modalStorageKey||`tcf_${r.__type}_${n.name}`,onUpdate:a,referenceElementId:n.referenceElementId,referenceElementSiteId:n.referenceElementSiteId,showSiteMenu:n.showSiteMenu,sources:n.sources||null,viewMode:n.viewMode})}(0,W.Cg)([_t],Ts.prototype,"asBackground",null),(0,W.Cg)([_t],Ts.prototype,"asLargeElement",null),(0,W.Cg)([_t],Ts.prototype,"asLargeImage",null),(0,W.Cg)([_t],Ts.prototype,"asSmallElement",null),(0,W.Cg)([_t],Ts.prototype,"asSmallImage",null),(0,W.Cg)([_t],Ts.prototype,"firstLabel",null),(0,W.Cg)([_t],Ts.prototype,"label",null),(0,W.Cg)([Ot],Ts.prototype,"toHTML",null),(0,W.Cg)([Ot],Ts.prototype,"toString",null)
class Rs extends cn{createValue({field:e}){return e.defaultValue&&this.isValue(e,e.defaultValue)?e.defaultValue:e.options[0].key}isValue(e,t){return e.options.some((e=>e.key==t))}preview({field:e,value:t}){const n=e?e.options.find((e=>e.key===t)):void 0
return n?n.label:"-"}}function Us({data:e,disabled:t,onUpdate:n,field:r}){return s.createElement(Ye,{disabled:t,onChange:n,options:r.options,value:e})}function Ds(e){let t
return e&&(t="color"in e?e.color:e.label),"string"==typeof t?t:"transparent"}class Fs extends s.Component{constructor(){super(...arguments),this.state={isExpanded:!1},this.handleFlyoutClick=()=>{this.setState({isExpanded:!1})},this.handleSelect=e=>{this.props.onUpdate(e.key),this.setState({isExpanded:!1})},this.handleSwatchClick=e=>{e.currentTarget===e.target&&this.setState({isExpanded:!0})}}render(){const{data:e,disabled:t,field:n}=this.props,{isExpanded:r}=this.state,a=n.options.find((t=>t.key===e))
return s.createElement("div",{className:je()("tcfSwatchColorWidget",{isUndecided:!a}),onClick:t?void 0:this.handleSwatchClick,style:{background:a?Ds(a):void 0}},r&&!t?this.renderFlyout(a):null)}renderFlyout(e){const{field:t}=this.props
return s.createElement(Gt,{onClick:this.handleFlyoutClick},s.createElement("div",{className:"tcfSwatchColorWidget--swatches"},t.options.map((t=>s.createElement("div",{className:je()("tcfSwatchColorWidget--swatch",{isSelected:t===e}),key:t.key,onClick:()=>this.handleSelect(t),style:{background:Ds(t)}})))))}}function Vs({data:e,disabled:t,errors:n,field:{maxLength:r,minLength:a,placeholder:i,inputType:l},onUpdate:o}){return s.createElement("input",{autoComplete:"off",className:je()("tcfTextWidget text fullwidth",{error:n&&n.length}),disabled:t,maxLength:r,minLength:a,onChange:e=>o(e.target.value),placeholder:i,type:l,value:e?`${e}`:""})}function Hs({data:e,disabled:t,field:{maxLength:n,minLength:r,monospace:a,placeholder:i,rows:l},onUpdate:o}){return s.createElement("textarea",{className:je()("tcfTextareaWidget text fullwidth",{monospace:a}),disabled:t,maxLength:n,minLength:r,onChange:e=>o(e.target.value),placeholder:i,rows:l,value:e})}function Ws(e,t){const n=[],s=d(e,t.__uuid)
if(!s)return n
const{path:r}=s
let a,i=e.model
for(;i&&(a=r.shift());)c(i)&&n.push(i),i=h(i,a)
return n}function Bs(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function zs(e){const t=e.indexOf(":")
let n,s=-1===t?e.trim():e.substring(t+1).trim()
return n=-1===t?"template:":e.substring(0,t+1),s=function(e,t){return"template:"===t&&(e=e.replace(/\\/,"/")).endsWith(".twig")&&(e=e.substring(0,e.length-5)),e}(s,n),{loader:n,name:s,uri:`${n}${s}`}}function qs(e){const t=e.split("*").map(Bs).join("[A-Za-z0-9-_]+")
return new RegExp(`/^${t}$/`)}const Xs=[{prefix:"\\\\",handler:function(e,t,n){return t.reduce(((t,s)=>{const r=Ws(e,s.model).reverse(),a=r.findIndex((e=>function(e,t){const n=zs(e)
for(const e of Array.isArray(t)?t:t.split(",")){const t=zs(e)
if(n.uri==t.uri)return!0
if(t.loader==n.loader&&-1!==t.name.indexOf("*")&&qs(t.name).test(n.name))return!0}return!1}(e.__type,n)))
return-1===a?t:[...t,{model:r[a],distance:s.distance+a}]}),[])}},{prefix:"\\",handler:function(e,t,n){return t.reduce(((e,t)=>e),[])}}]
function Ys(e,t,n){const s=n.lastIndexOf(".")
if(-1===s)return console.error(`Missing field: ${n}`),null
const r=n.substring(s+1),a=function(e,t,n){let s=[{distance:0,model:t}]
e:for(;n.length;){for(const{prefix:t,handler:r}of Xs){if(!n.startsWith(t))continue
...
return a&&r in a?a[r]:null}const Gs=function(){const e=document?document.currentScript:null
return e&&"src"in e?function(e){const t=e.lastIndexOf("/")
return-1!==t?e.substring(0,t):e}(e.src):""}(),Ks=[],Qs=`${Gs}/images/empty-pattern.webp`,Js={editUrl:Qs,height:500,listeners:[],previewUrl:Qs,url:Qs,width:500}
function Zs(e,t,n){const[r,a]=(0,s.useState)(Js),i=function(e,t,n){let s=null
for(const r of n){const n=Ys(e,t,r)
...
let l
return i&&(l=Ks.find((e=>e.url===i.url)),l||(l=function(e,t){const n=B(e.config.apiEndpoints.hotspotAsset,{id:t.id,siteId:t.siteId})
...
return Ks.push(s),s}(e,i))),(0,s.useEffect)((()=>{if(l){if(!l.width)return function(e,t){return e.listeners.push(t),()=>{const n=e.listeners.indexOf(t);-1!==n&&e.listeners.splice(n,1)}}(l,(()=>a(l)))
a(l)}else a(Js)}),[l]),r}const er=16,tr={scale:(e,t)=>Object.assign(Object.assign({},e),{x:e.x+t.x,y:e.y+t.y}),toBounds:(e,t)=>({height:2*er,width:2*er,x:t.x*e.width-er,y:t.y*e.height-er})}
function nr(e){const t={x:e.clientX,y:e.clientY}
let n=e.target
for(;n;){if("svg"===n.nodeName){const e=n.getBoundingClientRect()
t.x-=e.left,t.y-=e.top
break}n=n.parentElement}return t}function sr(e){return Array.isArray(e)&&e.every(rr)}function rr(e){return e&&"object"==typeof e&&"type"in e&&"uuid"in e}function ar(e,t,n){const r=(0,s.useRef)(n)
r.current=n,(0,s.useEffect)((()=>{const n=e=>r.current(e)
return e.addEventListener(t,n),()=>{e.removeEventListener(t,n)}}),[])}function ir(e,t,n=null){const s=n?1/n.width:1,r=n?1/n.height:1
return{height:Math.abs(e.y-t.y)*r,width:Math.abs(e.x-t.x)*s,x:Math.min(e.x,t.x)*s,y:Math.min(e.y,t.y)*r}}function lr(e){const[t,n]=s.useState({active:!1,from:{x:0,y:0},to:{x:0,y:0}})
return ar(window,"pointerup",(()=>{t.active&&(e.onTool(null),e.onChange([...e.shapes,Object.assign(Object.assign({},ir(t.from,t.to,e.viewport)),{type:"rectangle",uuid:_()})]))})),s.createElement("g",null,t.active?s.createElement("rect",Object.assign({className:"tcfHotspotEditor__shapeRectangle"},ir(t.from,t.to))):null,s.createElement("rect",{fillOpacity:"0",x:"0",y:"0",width:"100%",height:"100%",onPointerDown:function(e){const t=nr(e)
n((e=>Object.assign(Object.assign({},e),{active:!0,from:t,to:t})))},onPointerMove:function(e){n((t=>Object.assign(Object.assign({},t),{to:nr(e)})))}}))}function or(e,t){return{x:e.x+e.width*t.x,y:e.y+e.height*t.y}}const cr={scale(e,t,n){const s=or(e,n),r=or(e,{x:(a=n).x?0:1,y:a.y?0:1})
var a
return s.x+=t.x,s.y+=t.y,Object.assign(Object.assign({},e),ir(s,r))},toBounds(e,t,n){const s=t.height*e.height,r=t.width*e.width,a=n?0:Math.max(0,32-r),i=n?0:Math.max(0,32-s)
return{height:s+i,width:r+a,x:t.x*e.width-.5*a,y:t.y*e.height-.5*i}}}
const ur={point:function({isPreview:e,onSelect:t,shape:n,viewport:r}){return s.createElement("circle",{className:"tcfHotspotEditor__shapePoint",cx:n.x*r.width,cy:n.y*r.height,onPointerDown:t?e=>t(n,{x:e.screenX,y:e.screenY}):void 0,r:e?5:er})},rectangle:function({isPreview:e,onSelect:t,shape:n,viewport:r}){return s.createElement("rect",Object.assign({className:"tcfHotspotEditor__shapeRectangle",onPointerDown:t?e=>t(n,{x:e.screenX,y:e.screenY}):void 0},cr.toBounds(r,n,e)))}},dr={point:tr,rectangle:cr}
function mr(e,t){return e.map((e=>s.createElement(ur[e.type],Object.assign(Object.assign({},t),{key:e.uuid,shape:e}))))}function hr(e){var{children:t}=e,n=(0,W.Tt)(e,["children"])
const r=s.useRef(null)
return s.useLayoutEffect((()=>{const{current:e}=r
e&&e.showModal()}),[]),s.createElement("dialog",Object.assign({},n,{className:"tcfHotspotEditor__dialog",ref:r}),s.createElement("button",{className:"tcfHotspotEditor__dialogCloser",onClick:n.onClose},s.createElement(He,{name:"material:close"})),t)}const pr=s.forwardRef(((e,t)=>{var{children:n,onImagePointerDown:r,url:a}=e,i=(0,W.Tt)(e,["children","onImagePointerDown","url"])
...
function fr(e){const[t,n]=s.useState({active:!1,x:0,y:0})
return ar(window,"pointerup",(()=>{t.active&&(e.onTool(null),e.onChange([...e.shapes,{type:"point",uuid:_(),x:t.x/e.viewport.width,y:t.y/e.viewport.height}]))})),s.createElement("g",null,t.active?s.createElement("circle",{className:"tcfHotspotEditor__shapePoint",r:er,cx:t.x,cy:t.y}):null,s.createElement("rect",{fillOpacity:"0",x:"0",y:"0",width:"100%",height:"100%",onPointerDown:function(e){n((t=>Object.assign(Object.assign(Object.assign({},t),nr(e)),{active:!0})))},onPointerMove:function(e){n((t=>Object.assign(Object.assign({},t),nr(e))))}}))}function gr({allowCreate:e,allowDelete:t,allowedShapes:n,currentTool:r,onChange:a,onTool:i}){function l(e){return!n||n.some((t=>t===e))}return s.createElement("div",{className:"tcfHotspotEditor__toolbar"},l("point")?s.createElement("button",{className:je()("tcfHotspotEditor__toolbarButton",{active:r===fr}),disabled:!e,type:"button",onClick:()=>i({Component:fr,props:{}})},s.createElement(He,{name:"material:gps_fixed"}),s.createElement("span",null,"Hotspot")):null,l("rectangle")?s.createElement("button",{className:je()("tcfHotspotEditor__toolbarButton",{active:r===lr}),disabled:!e,type:"button",onClick:()=>i({Component:lr,props:{}})},s.createElement(He,{name:"material:crop"}),s.createElement("span",null,"Ausschnitt")):null,s.createElement("button",{className:"tcfHotspotEditor__toolbarButton",disabled:!t,type:"button",onClick:()=>{i(null),a([])}},s.createElement(He,{name:"material:delete"}),s.createElement("span",null,"Alle löschen")))}const yr=12,vr=[{x:0,y:0},{x:1,y:0},{x:0,y:1},{x:1,y:1}]
function br(e){const t=e.shapes.find((t=>t.uuid===e.uuid))
if(!t)return null
const{viewport:n}=e,r=function(e){return dr[e.type]}(t),a=r.toBounds(n,t),[i,l]=s.useState({handle:{x:0,y:0},mode:e.origin?"translate":null,origin:e.origin||{x:0,y:0},shape:t}),o=t=>{e.onChange([...e.shapes.filter((e=>e.uuid!==i.shape.uuid)),...t?[t]:[]])}
return ar(e.svg,"pointermove",(({screenX:e,screenY:t})=>{const{origin:s,shape:a}=i,l=(e-s.x)/n.width,c=(t-s.y)/n.height
"translate"===i.mode?o(Object.assign(Object.assign({},a),{x:a.x+l,y:a.y+c})):"scale"===i.mode&&o(r.scale(a,{x:l,y:c},i.handle))})),ar(window,"pointerup",(()=>{l((e=>Object.assign(Object.assign({},e),{mode:null})))})),ar(window,"keydown",(({key:t})=>{"Delete"===t&&(e.onTool(null),o(null))})),s.createElement("g",null,s.createElement("rect",{className:"tcfHotspotEditor__hitArea",onPointerDown:e=>{l((n=>Object.assign(Object.assign({},n),{mode:"translate",origin:{x:e.screenX,y:e.screenY},shape:t})))},x:a.x,y:a.y,width:a.width,height:a.height}),vr.map(((e,n)=>s.createElement("rect",{className:"tcfHotspotEditor__handle",key:`handle_${n}`,onPointerDown:n=>((e,n)=>{l((s=>Object.assign(Object.assign({},s),{handle:n,mode:"scale",origin:{x:e.screenX,y:e.screenY},shape:t})))})(n,e),height:yr,width:yr,x:a.x+(e.x?a.width:-yr),y:a.y+(e.y?a.height:-yr)}))))}function Er(e){const{asset:t,maxShapes:n,onClose:r,shapes:a}=e,i=function(e,t=80){const[n,r]=(0,s.useState)(a)
...
return s.createElement(hr,{onClose:r},s.createElement("div",{className:"tcfHotspotEditor"},s.createElement(gr,{allowCreate:!n||a.length<n,allowDelete:a.length>0,allowedShapes:e.allowedShapes,currentTool:o?o.Component:null,onChange:e.onChange,onTool:c}),s.createElement(pr,{height:i.height,ref:l,url:t.editUrl,width:i.width,onImagePointerDown:()=>c(null)},mr(a,{onSelect:function(e,t=null){c({Component:br,props:{key:e.uuid,origin:t,uuid:e.uuid}})},viewport:i}),o?s.createElement(o.Component,Object.assign({},o.props,e,{onTool:c,svg:l.current,viewport:i})):null)))}function wr({asset:e,onClick:t,shapes:n}){const r=Math.min(120/e.width,120/e.height),a={height:Math.round(e.height*r),scale:r,width:Math.round(e.width*r)}
return s.createElement("div",{className:je()("tcfHotspotPreview",{clickable:!!t}),onClick:t},s.createElement("div",{className:"tcfHotspotPreview__thumb"},s.createElement(pr,{height:Math.round(a.height),url:e.previewUrl,width:Math.round(a.width)},mr(n,{isPreview:!0,viewport:a}))))}const Cr=(0,l.Ng)((e=>({state:e})))((function({data:e,disabled:t,field:n,model:r,onUpdate:a,state:i}){const[l,o]=s.useState(!1),c=Zs(i,r,n.assetQuery),u=sr(e)?e:[]
return s.createElement(s.Fragment,null,s.createElement(wr,{asset:c,onClick:t?void 0:()=>o(!0),shapes:u}),l?s.createElement(Er,{allowedShapes:n.allowedShapes,asset:c,maxShapes:n.maxShapes,onChange:e=>a(e),onClose:()=>o(!1),shapes:u}):null)}))
...
i&&(a[t]=i.preview({context:Object.assign(Object.assign({},e),{depth:e.depth+1}),field:r,value:n[t]}))}return a}},layout:new class extends cn{constructor(){super({widget:ns})}cloneValue(e){return(0,W.sH)(this,void 0,void 0,(function*(){const{field:t,value:n}=e,s=(0,W.Tt)(e,["field","value"]),{schemas:r}=s
...
return new ge.SafeString(`<div class="tcpRow">${o.join("")}</div>`)}},lightswitch:new class extends un{constructor(){super({widget:ss})}},link:new class extends cn{constructor(){super({widget:fs})}cloneValue(e){const t=Object.create(null,{cloneValue:{get:()=>super.cloneValue}})
return(0,W.sH)(this,void 0,void 0,(function*(){const n=yield t.cloneValue.call(this,e)
return n.siteId=yield gs(n.elementId,n.siteId,e),n}))}createValue(){return{elementId:0,hash:"",openInNewWindow:!1,siteId:0,type:"url",url:""}}isValue(e,t){return ps(t)}preview(){return""}},location:new class extends cn{constructor(){super({widget:xs})}createValue({field:e}){return ws(e.defaultValue)?Object.assign({},e.defaultValue):{latitude:0,longitude:0}}isValue(e,t){return ws(t)}preview({value:e}){return new ys(e)}},number:new class extends _s{constructor(){super({widget:Os})}},oembed:new class extends cn{constructor(){super({widget:Tn})}createValue(e){return{url:""}}isValue(e,t){return Vt(t)}preview({value:e}){return new $n(Vt(e)?e:{url:""})}},redactor:new class extends As{constructor(){super({widget:Ms})}preview({value:e}){return new Ns(e)}},reference:new class extends cn{constructor(){super({widget:$s})}cloneValue(e){const t=Object.create(null,{cloneValue:{get:()=>super.cloneValue}})
return(0,W.sH)(this,void 0,void 0,(function*(){const n=yield t.cloneValue.call(this,e)
for(const t of n)t.siteId=yield gs(t.id,t.siteId,e)
return n}))}createValue(e){return[]}isValue(e,t){return Array.isArray(t)&&t.every(w)}preview(e){return new Ts(e)}},select:new class extends Rs{constructor(){super({widget:Us})}},swatchcolor:new class extends Rs{constructor(){super({widget:Fs})}},text:new class extends As{constructor(){super({widget:Vs})}},textarea:new class extends As{constructor(){super({widget:Hs})}}})
const Sr=[],xr={},Or={create:e=>{try{let t=null
...
Sr.push(d),d.subscribe((()=>{const{draftEditor:e}=window,n=JSON.stringify(d.getState().model)
u.value!==n&&e&&(t&&window.clearTimeout(t),t=window.setTimeout((()=>{e.checkForm(),t=null}),500)),u.value=n})),r.render(s.createElement(l.Kq,{store:d},s.createElement(Et,null)),o)}catch(e){console.error("Could not start content editor.",e)}},getInstanceApi:e=>{for(const t of Sr){const n=d(t.getState(),e)
return n?pe(t,n):null}},getValidator:function(e){return e in xr?xr[e]:null},registerValidator:(e,t)=>{xr[e]=t}}
if(window){const e=window;(e.lenz||(e.lenz={})).contentField=Or}const _r=Or}},n={}
