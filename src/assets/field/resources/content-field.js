...
const Ie=Me
function Le({onClose:e}){return s.createElement(Ie,{width:600},s.createElement(Ie.Content,null,s.createElement(ke,{value:"Cannot create an element at the given location."})),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:e,secondary:!0},s.createElement(ke,{value:"Cancel"}))))}const Te="toolbar"
function $e({children:e,isBorderless:t,label:n,style:a}){return n&&""!==n&&n!==Te?s.createElement("div",{className:"tcfFieldGroup",style:a},s.createElement("div",{className:"tcfFieldGroup--label"},n),s.createElement("div",{className:"tcfFieldGroup--content"},e)):s.createElement("div",{className:Ce()("tcfFieldGroup--content",{isBorderless:t}),style:a},e)}function Ae({children:e,className:t,errors:n,instructions:a,isPlainField:r,isRequired:i,label:l,style:o}){if(r)return s.createElement(s.Fragment,null,e)
const c=n&&n.length
...
c(s)&&("expand"===e?a.toggleExpanded(s.__uuid,!0):i={type:"edit",uuid:s.__uuid}),n(function(e,t,n){return{position:n,type:"uuidInsert",uuid:e,value:t}}(t,s,r)),n(N(i))},scope:o.__type})}function We(e){const{field:t}=e,{widget:n}=v.getDefinition(t)
...
u={index:e===Te?-1:o.length,label:e,fields:[],style:t},o.push(u)}u.fields.push(s.createElement(Ae,{errors:m,instructions:c.instructions,isPlainField:t||h,isRequired:c.isRequired,key:c.name,label:c.label,style:Ve(l,c.style)},s.createElement(We,{data:n[c.name],disabled:e,errors:m,field:c,model:n,onUpdate:e=>a(d,e),path:r})))}const d=o.sort(ze).map((e=>s.createElement($e,{isBorderless:t,key:e.index,label:e.label,style:e.style},e.fields))),m=Ve(l,i.style)
...
case"synchronize":return s.createElement(rt,null)}}(n)):null))}function ht(e={config:{apiEndpoints:{anchors:"",fetchSite:"",oembed:"",translate:""},csrfTokenName:"",csrfTokenValue:"",disabled:!1,elementId:null,elementSiteId:0,fieldHandle:"",hasTranslator:!1,references:[],rootSchemas:[],supportedSites:[]},model:{__errors:{},__type:"unknown",__uuid:"0",__visible:!0},overlay:null,schemas:{},sync:{status:"idle"},user:{favoriteSchemas:{}}},t){return t.type in te?te[t.type](e,t):e}function pt(e){for(;"string"!=typeof e;)e=e.toHTML()
...
f(d)
return s.createElement("div",{className:Ce()(`tcfArrayWidgetMember depth-${n}`,{isDragging:m}),ref:d},p(s.createElement("div",{className:"tcfArrayWidgetMember--panel tcfArrayWidgetMember--single"},h(s.createElement("div",{className:Ce()("tcfArrayWidgetMember--singleHandle",{enabled:!a})},s.createElement(Ye,{className:"tcfArrayWidgetMember--singleHandleIcon",key:"handle",name:"move"}))),s.createElement("div",{className:"tcfArrayWidgetMember--singleBody"},s.createElement(We,{data:t,disabled:a,errors:[],field:r,model:l,onUpdate:e=>{c(i,e)},path:u})),a?null:s.createElement("div",{className:"tcfArrayWidgetMember--singleActions"},s.createElement("div",{className:"tcfArrayWidgetMember--singleActionsButton",onClick:()=>{o(i)}},s.createElement(Ye,{name:"remove"}))))))}function kt(e){const t=s.useRef(null),[,n]=function(e){const t=(0,l.oR)()
...
return s.createElement("div",{className:"tcfArrayWidgetMember--headerMore"},s.createElement("div",{className:"tcfArrayWidgetMember--headerMoreButton",onMouseDown:this.handleMouseDown},s.createElement(Ye,{name:"material:more_vert"})),t?s.createElement(Rt,{onClick:this.handleClose},s.createElement(Pt,{onClose:this.handleClose,uuid:e})):null)}}function Ft(e){return e}function Dt(e,t){return t?e?"minus":"plus":e?"done":"edit"}function Wt({disabled:e,dragSource:t=Ft,field:n,hasPreview:a,isCollapsible:r,isExpanded:i,model:l,onToggleExpanded:o,schema:c}){const u=[]
return c?(u.push(s.createElement(Ye,{key:"icon",name:c.icon})),c.previewImage&&u.push(s.createElement(Lt,{key:"image",model:l,schema:c})),u.push(s.createElement("div",{className:Ce()("tcfArrayWidgetMember--headerLabel",{isHidden:!l.__visible}),key:"label"},c.label)),a&&c.previewLabelTemplate&&u.push(s.createElement("div",{className:"tcfArrayWidgetMember--headerPreview",key:"preview"},s.createElement($t,{field:n,model:l})))):u.push(s.createElement(Ye,{className:"tcfArrayWidgetMember--headerHandleIcon",key:"handle",name:"move"})),s.createElement("div",{className:"tcfArrayWidgetMember--header"},t(s.createElement("div",{className:Ce()("tcfArrayWidgetMember--headerHandle",{enabled:!e}),onClick:o},u)),l.__visible?null:s.createElement(Ye,{className:"tcfArrayWidgetMember--headerVisibility",name:"material:visibility_off"}),s.createElement("div",{className:"tcfArrayWidgetMember--headerActions"},r?s.createElement(jt,{onClick:o,primary:!e},s.createElement(Ye,{name:Dt(i,e)})):null,e?null:s.createElement(Ut,{uuid:l.__uuid})))}const Vt=s.memo((function({field:e,model:t,mode:n="default",references:a,schemas:r}){const i=v.getDefinition("instance").preview({context:{depth:0,references:a,schemas:r},field:e,mode:n,value:t})
...
let C
return w?C=s.createElement("div",{className:"tcfArrayWidgetMember--body"},s.createElement(ut,{canChangeType:!1,disabled:d,isBorderless:b,key:"details",model:c,path:p,schemaNames:m.schemas})):E&&(C=s.createElement(Ht,{className:"tcfArrayWidgetMember--preview",field:m,key:"summary",model:c,onClick:v?y:void 0})),s.createElement("div",{className:Ce()(`tcfArrayWidgetMember depth-${u}`,w?"isExpanded":"isCollapsed",{isDragging:r}),ref:a},l(s.createElement("div",{className:"tcfArrayWidgetMember--panel"},s.createElement(Wt,{disabled:d,dragSource:i,field:m,hasPreview:!w&&!E,isCollapsible:v&&h,isExpanded:w,model:c,onToggleExpanded:y,schema:g}),s.createElement(Nt,{uri:w?"details":"summary"},C))))}function zt({children:e,data:t,disabled:n,field:a,model:r,onDelete:i,onUpdate:o,path:c}){const{member:u,collapsible:d,previewMode:m}=a,h=s.useRef(null),p=(0,l.v9)((e=>e.schemas)),f=s.useContext(it),g=t.map(((e,t)=>{const a=[...c,{index:t,name:u.name,type:"index"}],l={child:e,depth:f,disabled:n,path:a}
...
let p=null
return d?p=s.createElement("div",{className:"tcfArrayWidgetMember--body"},e):m&&(p=s.createElement(Ht,{field:n,model:a,onClick:h})),s.createElement("div",{className:`tcfInstanceWidget--collapsiblePanel depth-${r}`},s.createElement(Wt,{disabled:t,field:n,hasPreview:!d&&!m,isCollapsible:!0,isExpanded:d,model:a,onToggleExpanded:h,schema:u}),s.createElement(Nt,{uri:d?"details":"summary"},p))}function Mn({className:e,data:t,disabled:n,field:a,path:r}){const i=s.createElement(ut,{canChangeVisibility:!0,disabled:n,model:t,path:[...r,{type:"property",name:a.name}],schemaNames:a.schemas})
...
var h}function Ln(e,t=0,n=1){return e<t?t:e>n?n:e}function Tn({columnsPerRow:e}){const t=[]
for(let n=0;n<e;n++)t.push(s.createElement("div",{className:"tcfLayoutPreview--gridColumn",key:n}))
return s.createElement("div",{className:"tcfLayoutPreview--grid"},t)}function $n(e){const t=String.fromCharCode(65+e%25),n=Math.floor(e/25)
...
function h(e){d(e===u?null:e)}return s.createElement(Ie,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfLayoutEditor--title"},s.createElement(ke,{value:"Edit columns"})),i.map((e=>s.createElement(Fn,Object.assign({},r,{current:e,key:e.key,selected:m,onSelect:h}))))),s.createElement(Ie.Footer,null,s.createElement("div",{className:"btngroup"},l.length<o?s.createElement(xe,{onClick:()=>d(n())},s.createElement(Ye,{name:"plus"}),s.createElement(ke,{value:"Create"})):null,m&&l.length>c?s.createElement(xe,{onClick:()=>a(m.__uuid)},s.createElement(Ye,{name:"minus"}),s.createElement(ke,{value:"Delete"})):null),s.createElement(xe,{onClick:t,primary:!0},s.createElement(ke,{value:"Close"}))))}function Wn(e){var{onClose:t,onPreset:n,preset:a,presets:r}=e,i=(0,P._T)(e,["onClose","onPreset","preset","presets"])
