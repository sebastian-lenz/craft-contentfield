...
function U(e){var{source:t}=e,n=(0,P._T)(e,["source"])
...
s[a]=yield i.cloneValue(Object.assign(Object.assign({},n),{field:r,value:t[a]}))}return s}))}function R(e){var{apiEndpoint:t}=e,n=(0,P._T)(e,["apiEndpoint"])
...
let n
if(-1===e)i.info(`No array match for ${i.model(t)}`),n=yield U(Object.assign(Object.assign({},a),{source:t}))
else{const s=r[e]
...
for(let s=0;s<t.columns.length;s++){const a=t.columns[s],r=yield U(Object.assign(Object.assign({},n),{source:a}))
...
if(!c(n)||n.__type!==t.__type)return n?e.info(`Type missmatch, cloning ${e.model(t)}`):e.info(`No target, cloning ${e.model(t)}`),U(Object.assign(Object.assign({},s),{source:t}))
...
const{data:l,references:o}=yield R({apiEndpoint:e.apiEndpoints.fetchSite,elementId:e.elementId,fieldHandle:e.fieldHandle,siteId:s})
if(!c(l)||!e.rootSchemas.some((e=>e===l.__type)))throw new Error("Selected target site does not contain a valid model.")
const u=c(r)&&r.__type===l.__type?yield Z(Object.assign(Object.assign({},a),{schemas:i,source:l,target:r})):yield U(Object.assign(Object.assign({},a),{schemas:i,source:l}))
...
return s.createElement(s.Fragment,null,s.createElement(Ie.Content,null,s.createElement("div",{className:"tcfSynchronize--title"},s.createElement(ke,{value:"Synchronize translations"})),s.createElement(Te,null,s.createElement(Ae,{instructions:g("Select the site the content should be copied from."),label:g("Site")},s.createElement(Ue,{onChange:this.handleSiteChange,options:o,value:i})),s.createElement(Ae,{instructions:g("Defines what happens to elements that do not exist in the selected language."),label:g("Orphaned elements")},s.createElement(Ue,{onChange:this.handleArrayOrphanModeChange,options:[{key:"hide",label:g("Hide orphaned elements")},{key:"none",label:g("Do nothing")},{key:"remove",label:g("Remove orphaned elements")}],value:r})),i&&t&&i.language!==t.language?s.createElement(Ae,{instructions:g(n?"Uses a webservice to automatically translate texts.":"A matching webservice must be configured in the options of this field in order to use this feature."),label:g("Translate texts automatically")},s.createElement(et,{disabled:!n,onChange:this.handleToggleTranslator,value:l})):null)),s.createElement(Ie.Footer,null,s.createElement(xe,{onClick:a,secondary:!0},s.createElement(ke,{value:"Cancel"})),s.createElement(xe,{onClick:this.handleApply,primary:!0},s.createElement(ke,{value:"Apply"}))))}}const nt=(0,l.$j)((e=>{const{apiEndpoints:t,elementSiteId:n,hasTranslator:s,supportedSites:a}=e.config
...
class Ut extends s.Component{constructor(){super(...arguments),this.handle=null,this.handleStyle={left:"0px"},this.origin=null,this.panel=null,this.panelClassName="tcfFlyout--panel",this.panelStyle={left:"0px",top:"0px"},this.handleResize=()=>{this.update()},this.setHandle=e=>{this.handle=e,this.update()},this.setOrigin=e=>{this.origin=e,this.update()},this.setPanel=e=>{this.panel=e,this.update()}}componentDidMount(){window.addEventListener("resize",this.handleResize)}componentWillUnmount(){window.removeEventListener("resize",this.handleResize)}render(){const{children:e,onClick:t}=this.props
...
return s.createElement(ln,{color:t,onChange:r},s.createElement("div",{className:"tcfColorInput"},s.createElement(fn,{className:"tcfColorInput--swatch",disabled:a,onClick:this.handleSwatchClick},e&&!a?s.createElement(Ut,{onClick:this.handleOverlayClick},s.createElement(gn,{disableAlpha:n,presetColors:i})):null),s.createElement(un,{type:"hex"})))}}function vn({data:e,disabled:t,field:n,onUpdate:a}){const r=en(e)?e:{alpha:1,blue:255,green:255,red:255}
...
return Math.round(e/a)}}function Un(e){var{columns:t,selected:n}=e,a=(0,P._T)(e,["columns","selected"])
const{columnsPerRow:r}=a
return s.createElement("div",{className:"tcfLayoutRowEditor"},s.createElement($n,{columnsPerRow:r}),t.map(((e,t)=>s.createElement(Pn,Object.assign({},a,{column:e,index:t,isSelected:null!==n&&n.__uuid===e.__uuid,key:e.__uuid})))))}const Rn={xs:"material:smartphone",sm:"material:tablet_mac",md:"material:tablet",lg:"material:laptop",xl:"material:desktop_mac"}
...
return s.createElement("div",{className:"tcfLayoutEditor--row"},s.createElement("div",{className:"tcfLayoutEditor--rowHead"},a.key in Rn?s.createElement(Ye,{name:Rn[a.key]}):null,s.createElement("span",null,a.label)),s.createElement("div",{className:"tcfLayoutEditor--rowBody"},s.createElement(Un,Object.assign({},e)),i))}function Wn(e){var{onClose:t,onCreate:n,onDelete:a}=e,r=(0,P._T)(e,["onClose","onCreate","onDelete"])
...
return s.createElement(Ut,{onClick:t},s.createElement("div",{className:"tcfLayoutSelect--flyout"},r.map((e=>s.createElement(An,Object.assign({},i,{columns:e.columns,isSelected:e.key===a,key:e.key,onClick:()=>n(e)}))))))}function Vn(e){var{canEdit:t,onPreset:n,preset:a,presets:r}=e,i=(0,P._T)(e,["canEdit","onPreset","preset","presets"])
...
let n
t&&0===t.length?n=s.createElement(bn,{icon:"material:error"},"No locations found"):t&&(n=s.createElement(rs,{onSelect:this.handleResultsSelect,results:t})),e=s.createElement("div",{className:"tcfLocationFieldSearch--resolve"},n?s.createElement(Ut,{onClick:this.handleResultsCancel},n):null,s.createElement(xe,{onClick:this.handleResolve},s.createElement(ke,{value:"Resolve address"})))}return s.createElement("div",{className:"tcfLocationFieldSearch"},e,s.createElement("input",{className:"tcfLocationFieldSearch--input tcfInput",ref:this.setInput,type:"search"}))}}function os(e){return"object"==typeof e&&"number"==typeof e.latitude&&"number"==typeof e.longitude}var cs
...
return n?n.label:"-"}}function _s({data:e,disabled:t,onUpdate:n,field:a}){return s.createElement(Ue,{disabled:t,onChange:n,options:a.options,value:e})}function Os(e){let t
...
return this.isValue(t,n)?U(Object.assign(Object.assign({},s),{source:n})):this.createValue(e)}))}createValue({field:e,schema:t,schemas:n}){if(t||(t=n[e.schemas[0]]),!t)throw new Error("The option `schema` is required when creating instances.")
