...
Craft.setElementSize(e,o),_t().load(e)}},[s.current]),d&&d.hasThumb?t.createElement("div",{className:Hn("tcfInstancePreviewImage",n,o),dangerouslySetInnerHTML:{__html:d.element},ref:s}):t.createElement("div",{className:Hn("tcfInstancePreviewImage empty",n,o)})}function St(e){var n=_slicedToArray(i.useSelector(function(e){return[e.config.references,e.schemas]}),2),r=n[0],a=n[1]
...
return t.createElement(Lr,{criteria:a.criteria,data:[r.elementId],disabled:n,elementType:a.elementType,limit:1,onUpdate:function(e){return i(Object.assign({},r,{elementId:e.length?e[0]:0}))},sources:a.sources,viewMode:"small"})}function mn(e){var n=e.disabled,r=e.link,a=e.linkType,i=e.onUpdate
return t.createElement(Xt,{disabled:n,type:a.inputType,value:r.url,onChange:function(e){return i(Object.assign({},r,{url:e.currentTarget.value}))}})}function hn(e){return"object"===_typeof(e)&&"number"==typeof e.elementId&&"string"==typeof e.type&&"string"==typeof e.url}function pn(e){var n,r=e.data,a=e.disabled,i=e.field,l=e.onUpdate
n=hn(r)?r:{elementId:0,openInNewWindow:!1,type:"",url:""}
